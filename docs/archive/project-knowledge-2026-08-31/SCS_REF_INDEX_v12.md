# SCS_REF_INDEX v12
**Supersedes v11. Updated 2026-08-22.**
...
| Doc | Version | Covers |
|---|---|---|
| **PP_X_POSTS** | **v52 ← NEW (full replacement)** | Sources, locked format, no character limit, sale check, six-category set, line-4 hybrid table, link selection, coded compounds, de-domain, news posts, vendor code master, vendor-own-offer conflicts |
...
**X posts** → **PP_X_POSTS v52 (this doc alone)** · PP's live `/coupons/<slug>` for code, catalog, line 4 · the vendor's own site for stock and the sale check
