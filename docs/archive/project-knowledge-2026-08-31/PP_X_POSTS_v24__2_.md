...
**Version:** v24 (May 31, 2026; upd. June 1) — adds the category-framed "other popular [group] peptides, including [X]" convention (list MULTIPLE same-group examples when available — more named peptides → more X impressions) + category-substitution rules (from the Ignite + Limitless + BioCollex rounds). Supersedes v23's post templates + "also has" guidance.
