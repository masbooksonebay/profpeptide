...
**X posts** → **PP_X_POSTS v54 (this doc alone)** · PP's live `/coupons/<slug>` for code, catalog, line 4 · the vendor's own site for stock and the sale check
...
**FAQ section state (2026-08-25):** nine question pages LIVE at `f4fd5c4` — needle pilot, insulin needles, bac water, and six compound dosing pages (reta/tirz/sema cited-protocol; CJC-Ipa frequency-framed; BPC-157/TB-500 honest no-protocol). PP_FAQ v4 §4 is the state table. **Next: side-effects pilot (thymosin beta-4).** Standing rules now in force: profile "Common question →" links · pinned Where-to-Buy trio on every compound FAQ page · citations decide the page shape.

**Profile audit QUEUED (Mark, 2026-08-25):** CC may audit peptide profiles for content and consistency. Known defect driving it: **BPC-157 and TB-500 profiles carry entirely uncited dosing sections** (convention figures, Huberman protocol, mcg/kg conversions — no citation markers). Scope in PP_FAQ v4 §5.
...
**v16 (August 25, 2026):** **PP_FAQ v4** (state, evidence split, standing rules). **PP_X_POSTS v54** (EZ sale example expired; /prices OG outage recorded; FAQ pages linkable). **PP_INBOUND_VENDORS v6** (Gate F). Standing corrections: FAQ state · the queued profile audit · Hydro as inbound #10.
