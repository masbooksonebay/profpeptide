# PP_FAQ — v3
**Status:** ACTIVE. The governing doc for the FAQ section. Supersedes v2, v1, and the planning framing in PP_ANSWERS v1–v2 — those remain as research records; THIS doc states what the project is.
**Date:** 2026-08-25
