...
**Date:** 2026-08-30 — v6 adds §1b (WHY question pages, not profiles — the user-behaviour reasoning, recorded so Mark stops having to explain it) and §2b (the category × compound matrix: the three-level cluster, locked).
