...
export const searchIndex: SearchEntry[] = [
  ...
  { title: "Apigenin", url: "/supplements/apigenin", category: "supplement", description: "Chamomile flavonoid; GABA-A partial agonist for sleep and CD38 inhibition for NAD+", tags: ["sleep", "chamomile", "gaba", "nad"] },
  ...
  { title: "Glycine", url: "/supplements/glycine", category: "supplement", description: "Amino acid sleep aid; 3g before bed reduces sleep onset and improves sleep quality", tags: ["sleep", "amino acid", "body temperature"] },
  ...
  { title: "Melatonin", url: "/supplements/melatonin", category: "supplement", description: "Circadian sleep hormone; 0.5-4 mg for sleep onset and circadian rhythm support", tags: ["sleep", "circadian", "jet lag", "hormone"] },
  ...
  { title: "Tart Cherry", url: "/supplements/tart-cherry", category: "supplement", description: "Montmorency tart cherry for sleep and exercise recovery; melatonin and anthocyanins", tags: ["sleep", "recovery", "doms", "montmorency", "anthocyanins"] },
