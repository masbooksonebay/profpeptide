...
export const GO_SURFACES = ["coupon-card", "coupon-reveal", "reveal-modal", "coupon-hub-card", "coupon-hub-shop", "vendors-card", "profile-block", "price-grid", "featured-vendors", "ps-alternatives", "search"] as const;
