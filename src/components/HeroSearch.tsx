...
export default function HeroSearch() {
  return (
    <button
      ...
      className="group mx-auto mb-8 flex w-full max-w-4xl items-center gap-3 rounded-xl border border-[#D9DEE4] dark:border-slate-700 bg-white dark:bg-[#1e293b] px-4 py-3.5 text-left shadow-[0_1px_3px_rgba(16,24,40,0.08),0_4px_12px_-2px_rgba(16,24,40,0.08)] dark:shadow-sm hover:border-brand transition-colors"
    >
      <svg
