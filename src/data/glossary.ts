// Single source of truth for the /glossary page terms.
//
// The /glossary page renders from this array, and the DERIVED search index
// (scripts/gen-search-index.mjs) indexes each term individually from it — so a term
// added here is both displayed and searchable with no second list to maintain.
// Add a term to the right letter section; keep sections alphabetical.
