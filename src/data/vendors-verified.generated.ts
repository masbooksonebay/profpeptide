...
export const VENDORS_VERIFIED_ISO = "2026-08-24";

/** Human-readable form of {@link VENDORS_VERIFIED_ISO} for SERP-facing copy. */
export const VENDORS_VERIFIED_DATE = "August 24, 2026";
...
export const VENDORS_VERIFIED_SLUGS = ["99-purity-peptides","aero-peptides","almighty-peptides","alpha-peptides","ameano-peptides","amino-club","amino-x","amp-peptides","ascension-peptides","behemoth-labz","biocollex","biolongevity-labs","biopure-peptides","capstone-peptides","crush-research","ez-peptides","forge-performance-co","glacier-aminos","ignite-peptides","improved-peptides","integrative-peptides","ion-peptide","la-peptides","legendary-peptides","licensed-peptides","limitless-biotech","midwest-peptide","mile-high-compounds","modern-aminos","nextgen-peptides","nova-labs","nura-peptide","oasis-labs","particle-peptides","peptide-giants","peptide-partners","peptides-gg","peptidology","purerawz","purity-peptides","real-peptides","royal-peptides","science-based-peptides","spartan-peptides","swiss-chems","treasure-coast-peptides","valkyrie-peptides","vital-core-research"];
