...
export const faqQuestions: FaqQuestion[] = [
  ...
  {
    slug: "what-is-semaglutide-used-for",
    category: "uses",
    // Indications are still expanding (an oral Wegovy tablet label landed since the profile was
    // written); re-read against the labels rather than assuming this list is closed.
    reviewAfter: "2027-01-01",
    question: "What is semaglutide used for?",
    title: "What Is Semaglutide Used For? Approved Indications vs Studied Outcomes",
    metaDescription:
      "Semaglutide is FDA-approved across more indications than any other GLP-class drug — type 2 diabetes, chronic weight management, cardiovascular risk, heart failure and kidney disease. Which brand carries which indication, and what a trial measured versus what a label authorises.",
    searchTags: ["what is semaglutide used for","semaglutide uses","semaglutide indications","ozempic vs wegovy","what does semaglutide do","semaglutide approved for","semaglutide weight loss"],
    hubBlurb: "Which indication sits on which brand's label, what the trials behind them measured, and why a research-market vial carries no indication at all.",
    lede:
    ...
    body: [
      { kind: "heading", text: "The indication belongs to the label, not the molecule" },
      { kind: "p", text: "This is the distinction that makes semaglutide confusing to look up. Ozempic is the injectable authorised for glycaemic control in type 2 diabetes; Wegovy is the injectable authorised for chronic weight management; Rybelsus is the oral tablet authorised for type 2 diabetes. Same active molecule, different authorised uses, different dosing ceilings. Asking what semaglutide is approved for without naming the label produces an answer that is true of no actual product." },
      { kind: "heading", text: "What the trials measured" },
      { kind: "list", items: [
      ...
      { kind: "p", text: "Those are separate questions with separate endpoints. A trial that measured cardiovascular events did not measure weight as its primary outcome, and reading across them as though they were one body of evidence overstates what any single one established." },
      { kind: "heading", text: "Approved for something is not studied for everything" },
      { kind: "p", text: "The gap runs the other way here from most of this site. For an unapproved research peptide the risk is a marketed claim outrunning a thin literature. For semaglutide the literature is enormous, and the risk is assuming that breadth of approval transfers to any use someone has in mind. An indication is a specific population, a specific endpoint and a specific dose ceiling that a regulator examined — not a general endorsement of the molecule." },
      { kind: "heading", text: "What none of it says about a research vial" },
      { kind: "p", text: "Every indication above attaches to a manufactured, inspected product supplied at a defined concentration. A vial sold on the research market carries no indication, no approval and no regulatory examination of what is in it. The trial evidence describes what the molecule did under those conditions; it does not describe what is in an unapproved vial." },
    ],
    whereToBuy: { compoundSlug: "semaglutide" },
  },
  {
    slug: "what-are-the-side-effects-of-semaglutide",
    category: "side-effects",
    question: "What are the side effects of semaglutide?",
    title: "Semaglutide Side Effects: Reported Rates from the Trials",
    metaDescription:
      "Gastrointestinal effects dominate and are most pronounced during escalation — nausea 44%, diarrhoea 30%, vomiting 24% in trials. Reported rates with the study behind each, plus the head-to-head discontinuation figure against tirzepatide.",
    searchTags: ["semaglutide side effects","ozempic side effects","wegovy side effects","does semaglutide cause nausea","semaglutide nausea","semaglutide adverse events","is semaglutide safe"],
    hubBlurb: "The reported rates with the trial behind each, why escalation is when they cluster, and what a label warns about that a trial did not measure.",
    lede:
    ...
    body: [
      { kind: "heading", text: "Reported rates" },
      { kind: "table",
        caption: "Effects reported in the semaglutide trial programme, with the rate and where it was reported. Rates cluster during escalation rather than at maintenance.",
        headers: ["Effect", "Reported rate", "Reported in"],
        rows: [
          ...
          ["Discontinuation for GI effects", "5.6%", "SURMOUNT-5 (head-to-head)"],
        ],
        note: "Every figure here is an observed rate in a controlled trial population, not a prediction for any individual. The discontinuation figure is the one directly comparative number available in this class.",
      },
      { kind: "heading", text: "The one head-to-head number" },
      { kind: "p", text: "SURMOUNT-5 compared semaglutide against tirzepatide directly, and reported gastrointestinal discontinuation at 5.6% with semaglutide against 2.7% with tirzepatide. Most cross-compound safety comparisons in this field are assembled from separate trials with different populations, which makes them close to meaningless. This one is not, because both arms were randomised in the same study." },
      { kind: "heading", text: "Why escalation is when effects cluster" },
      { kind: "p", text: "The labelled titration exists for tolerability rather than efficacy — the published rationale is that starting at a maintenance dose raises adverse-event rates without improving outcomes. That is also why the reported rates are not evenly distributed across a course: they concentrate in the weeks following each step up, and the trials record most effects as mild to moderate and diminishing with continued administration." },
      { kind: "heading", text: "What the labels warn about that the trials did not measure" },
      { kind: "p", text: "The approved labels carry a boxed warning regarding thyroid C-cell tumours, drawn from rodent studies rather than from human trial findings. This is an important distinction to state precisely: it is a warning derived from an animal signal that human trials were not designed and not powered to resolve, so it is neither a rate nor a refutation. Pancreatitis and gallbladder events are reported in the trials at low rates, and hypoglycaemia is reported principally where the drug was combined with insulin or a sulfonylurea." },
      { kind: "heading", text: "What this data does not cover" },
      { kind: "p", text: "These rates come from controlled trials of an approved, inspected product administered at defined doses under supervision, with adverse events collected systematically. A vial bought on the research market is not that product, and the safety profile does not transfer to it: identity, purity and actual content are separate questions from pharmacology, and no rate table can speak to them." },
    ],
    whereToBuy: { compoundSlug: "semaglutide" },
  },
  {
    slug: "how-is-semaglutide-dosed",
    category: "dosing",
    question: "How is semaglutide dosed?",
    title: "How Is Semaglutide Dosed? Four Labels, Four Different Schedules",
    metaDescription:
      "Semaglutide has no single dosing schedule. Ozempic escalates to a 2 mg ceiling, Wegovy to 2.4 mg, the oral tablets run on entirely different milligram scales — and the four labels give four different missed-dose rules. Verified against each label.",
    searchTags: ["how is semaglutide dosed","semaglutide dosage","semaglutide dose schedule","ozempic dosage","wegovy dosage","semaglutide titration","semaglutide missed dose"],
    hubBlurb: "Why there is no such thing as “the semaglutide dose” — four labels, four ceilings and four different missed-dose rules, each attributed to the label it comes from.",
    lede:
      "There is no single semaglutide schedule, and this is the compound where that matters most. Four separate approved labels carry four different escalation ladders, four dose ceilings and four different missed-dose rules. A figure quoted without naming its label is not a semaglutide dose — it is one product’s dose applied to another.",
    body: [
      { kind: "heading", text: "The injectable ladders" },
      { kind: "p", text: "Wegovy, authorised for chronic weight management, starts at 0.25 mg once weekly for four weeks and titrates every four weeks to a maintenance dose of 2.4 mg once weekly, via 0.5, 1.0 and 1.7 mg. Ozempic, authorised for glycaemic control in type 2 diabetes, starts at the same 0.25 mg but its recommended maintenance dosages are 0.5 mg, 1 mg or 2 mg once weekly, with 2 mg the ceiling. The two ladders share a starting dose and diverge at the top." },
      { kind: "p", text: "Both labels increase only after at least four weeks at the current step, so remaining at a step longer is within the labelled schedule rather than a departure from it." },
      { kind: "heading", text: "The oral labels run on a different scale entirely" },
      { kind: "p", text: "Rybelsus, the oral tablet authorised for type 2 diabetes, is dosed at 3 mg, 7 mg or 14 mg once daily — milligram figures that look larger than the injectable ones because oral bioavailability is far lower, not because the exposure is larger. A more recent oral label for weight management escalates by day rather than by week: 1.5 mg for days 1–30, 4 mg for days 31–60, 9 mg for days 61–90, and 25 mg from day 91 onward. Reading an oral milligram figure as though it were an injectable one is the single most consequential mistake available on this subject." },
      { kind: "heading", text: "Four labels, four missed-dose rules" },
      { kind: "table",
        caption: "Missed-dose instructions, taken from each product’s own FDA label. They are not interchangeable, and no two of the four agree.",
        headers: ["Label", "Route", "Missed-dose rule as written"],
        rows: [
          ["Ozempic", "injectable, weekly", "administer within 5 days of the missed dose"],
          ["Wegovy", "injectable, weekly", "if the next scheduled dose is more than 2 days away, administer as soon as possible; if less than 2 days away, do not administer it"],
          ["Rybelsus / oral", "tablet, daily", "skip the missed dose and take the next dose the following day"],
        ],
        note: "Verified against each label on DailyMed rather than from secondary summaries. Reported here because the rules genuinely differ, not as instruction — the label governing any actual product is the one that applies to it.",
      },
      { kind: "heading", text: "What titration is doing" },
      { kind: "p", text: "The escalation is a tolerability mechanism, not an efficacy one. The published rationale across these labels is that starting at a maintenance dose raises gastrointestinal adverse-event rates without improving outcomes, which is why every one of the four ladders begins well below its ceiling. Semaglutide’s half-life of roughly a week is what makes a weekly interval coherent in the first place, and what makes each step take several weeks to reach steady state." },
      { kind: "cta", text: "To convert any of these milligram figures into syringe units for a given vial and volume, use the", href: "/calculator", label: "dosage calculator" },
    ],
    whereToBuy: { compoundSlug: "semaglutide" },
  },
  {
    slug: "how-much-bac-water-for-semaglutide",
    category: "injection",
    question: "How much bacteriostatic water for semaglutide?",
    title: "How Much Bacteriostatic Water for Semaglutide? Reconstitution Math",
    metaDescription:
      "Any volume works — the water sets the concentration, and the concentration sets the syringe units. A reference table for 5 mg and 10 mg vials across the labelled 0.25–2.4 mg dose points, with the arithmetic shown.",
    searchTags: ["how much bac water for semaglutide","semaglutide reconstitution","semaglutide bacteriostatic water","reconstitute semaglutide 5mg","semaglutide 10mg reconstitution","semaglutide units calculator"],
    hubBlurb: "The volume-to-concentration-to-units arithmetic for the 5 mg and 10 mg vials, tabulated against the labelled dose ladder.",
    lede:
      "There is no correct volume, because the water is a solvent rather than an ingredient. It sets the concentration, and the concentration sets how many syringe units a given milligram figure measures out to. The amount of semaglutide drawn for any dose is identical whichever volume is used — only the number on the barrel changes.",
    body: [
      { kind: "heading", text: "Why any volume works" },
      { kind: "p", text: "The powder in the vial is a fixed mass, and reconstituting it changes where that mass sits rather than how much of it there is. A larger volume spreads the same milligrams across more liquid, so each milligram occupies more barrel — the figure on the syringe goes up while the quantity drawn stays put. What the choice really trades is readability: a 100-unit insulin syringe holds 1 mL, so a pairing that pushes a single measurement past 100 units turns one draw into two." },
      { kind: "heading", text: "Reference table: volume, concentration, and syringe units" },
      { kind: "table",
        caption: "Units on a 100-unit (1 mL) insulin syringe. The dose points are the labelled Wegovy escalation steps, listed because they are the figures the approved schedule uses — not as a recommendation to use any of them. 5 mg and 10 mg are the two vial sizes most commonly listed.",
        headers: ["Vial + water", "Concentration", "0.25 mg", "0.5 mg", "1 mg", "1.7 mg", "2.4 mg"],
        rows: [
          ["5 mg + 1 mL", "5 mg/mL", "5 units", "10 units", "20 units", "34 units", "48 units"],
          ["5 mg + 2 mL", "2.5 mg/mL", "10 units", "20 units", "40 units", "68 units", "96 units"],
          ["10 mg + 1 mL", "10 mg/mL", "2.5 units", "5 units", "10 units", "17 units", "24 units"],
          ["10 mg + 2 mL", "5 mg/mL", "5 units", "10 units", "20 units", "34 units", "48 units"],
        ],
        note: "The arithmetic is: units = (dose in mg ÷ concentration in mg/mL) × 100. Note the 10 mg + 1 mL row — at 10 mg/mL the smallest labelled step measures 2.5 units, which is a hard measurement to read accurately on a 100-unit barrel. That is the legibility trade-off the volume choice is actually about.",
      },
      { kind: "cta", text: "To run these figures for a vial size or volume not tabulated here, use the", href: "/calculator", label: "dosage calculator" },
      { kind: "heading", text: "Bacteriostatic versus sterile water" },
      { kind: "p", text: "The two waters differ by one ingredient: bacteriostatic water carries 0.9% benzyl alcohol as a preservative, and sterile water carries nothing. That single difference decides how many times a vial can be opened, because the preservative is what suppresses whatever a needle carries in. With semaglutide the arithmetic makes this concrete rather than theoretical — at the labelled ladder, a 10 mg vial is a multi-month supply and gets entered a couple of dozen times before it is finished, which is a very different exposure from a compound used up inside a week." },
    ],
    whereToBuy: { compoundSlug: "semaglutide" },
  },
  {
    slug: "what-is-tirzepatide-used-for",
    category: "uses",
    // Cardiovascular (SURPASS-CVOT) and metabolic liver readouts are pending; re-read the
    // indication list against the labels rather than assuming it is closed.
    reviewAfter: "2027-01-01",
    question: "What is tirzepatide used for?",
    title: "What Is Tirzepatide Used For? Three Approvals and What Is Still Running",
    metaDescription:
      "Tirzepatide is approved for type 2 diabetes (Mounjaro), chronic weight management and moderate-to-severe obstructive sleep apnea (Zepbound). Cardiovascular outcomes are still running. What each approval rests on, and what dual agonism does and does not explain.",
    searchTags: ["what is tirzepatide used for","tirzepatide uses","tirzepatide indications","mounjaro vs zepbound","what does tirzepatide do","tirzepatide sleep apnea","tirzepatide approved for"],
    hubBlurb: "The three approved indications, the programme behind each, and what the GIP arm does and does not explain about the results.",
    lede:
      "Tirzepatide holds three approved indications across two brand labels: type 2 diabetes as Mounjaro, and chronic weight management plus moderate-to-severe obstructive sleep apnea as Zepbound. A cardiovascular outcomes trial is still running. As with semaglutide, the indication belongs to a specific label rather than to the molecule.",
    body: [
      { kind: "heading", text: "What each approval rests on" },
      { kind: "list", items: [
        "Type 2 diabetes — the SURPASS programme, which reported A1C reductions of 2.0–2.5%, supporting the Mounjaro approval in May 2022.",
        "Chronic weight management — the SURMOUNT programme. SURMOUNT-1 reported average weight loss of 20.9% at 15 mg over 72 weeks, supporting the Zepbound approval in November 2023.",
        "Obstructive sleep apnea — SURMOUNT-OSA, which reported reductions in apnea severity and supported a December 2024 label expansion. This one is worth noting because it is an approval for a condition rather than for weight itself.",
      ]},
      { kind: "heading", text: "The head-to-head result" },
      { kind: "p", text: "SURMOUNT-5 randomised tirzepatide against semaglutide in the same study and reported 20.2% average weight loss against 13.7%. That is the rare directly comparative figure in this field. It should be read as what it is: one trial, one population, one pair of dose ceilings — not a general ranking of the two molecules across every use." },
      { kind: "heading", text: "What is still running" },
      { kind: "p", text: "SURPASS-CVOT is an ongoing cardiovascular outcomes trial in people with type 2 diabetes and established cardiovascular disease. A post-hoc analysis of SURMOUNT-5 projected greater ten-year cardiovascular risk reduction with tirzepatide than semaglutide, and a projection from a post-hoc analysis is a hypothesis rather than an outcome. Metabolic liver disease and heart failure are also under investigation." },
      { kind: "heading", text: "What dual agonism explains, and what it does not" },
      { kind: "p", text: "Tirzepatide engages both the GLP-1 and GIP receptors where semaglutide engages GLP-1 alone, and that second arm is the usual explanation offered for the larger weight figures. The mechanism is real and the difference in results is measured. The step that does not follow is treating a mechanistic difference as a general prediction: the head-to-head advantage was measured on weight, in one trial, and does not automatically extend to indications neither compound has been compared on." },
    ],
    whereToBuy: { compoundSlug: "tirzepatide" },
  },
  {
    slug: "what-are-the-side-effects-of-tirzepatide",
    category: "side-effects",
    question: "What are the side effects of tirzepatide?",
    title: "Tirzepatide Side Effects: Reported Rates from the Trials",
    metaDescription:
      "Gastrointestinal effects dominate and cluster during escalation — nausea 18–33%, diarrhoea 12–23% in trials. Reported rates with the study behind each, plus the head-to-head discontinuation figure of 2.7% against semaglutide's 5.6%.",
    searchTags: ["tirzepatide side effects","mounjaro side effects","zepbound side effects","does tirzepatide cause nausea","tirzepatide adverse events","tirzepatide vs semaglutide side effects","is tirzepatide safe"],
    hubBlurb: "The reported rates with the trial behind each, the head-to-head discontinuation figure, and what a boxed warning drawn from rodent data does and does not establish.",
    lede:
    ...
    body: [
      { kind: "heading", text: "Reported rates" },
      { kind: "table",
        caption: "Effects reported in the tirzepatide trial programme, with the rate and where it was reported. Ranges reflect different doses across studies; the higher figure is generally the peak-dose arm.",
        headers: ["Effect", "Reported rate", "Reported in"],
        rows: [
          ["Nausea", "18–33%", "SURPASS / SURMOUNT, peak doses"],
          ["Diarrhoea", "12–23%", "SURPASS / SURMOUNT"],
          ["Constipation", "6–17%", "SURPASS / SURMOUNT"],
          ["Vomiting", "8–13%", "SURPASS / SURMOUNT"],
          ["Discontinuation for GI effects", "2.7%", "SURMOUNT-5 (head-to-head)"],
        ],
        note: "Every figure here is an observed rate in a controlled trial population, not a prediction for any individual. Injection-site reactions, fatigue in the 48–72 hours after administration, and transient liver-enzyme elevations were also reported, at rates the published summaries do not consistently quantify.",
      },
      { kind: "heading", text: "The comparative figure, and its limits" },
      { kind: "p", text: "SURMOUNT-5 is the reason a tirzepatide-versus-semaglutide tolerability comparison can be made at all: both arms were randomised within one study, so the 2.7% against 5.6% discontinuation figure is not an artefact of different populations. What it does not establish is a general tolerability ranking. It measured discontinuation in one trial at one pair of dose ceilings, and the compounds’ escalation ladders differ in both length and step size, which is itself a plausible contributor." },
      { kind: "heading", text: "The boxed warning, stated precisely" },
      ...
      { kind: "heading", text: "What this data does not cover" },
      { kind: "p", text: "These rates come from controlled trials of an approved, inspected product administered at defined doses under supervision. A vial bought on the research market is not that product, and the safety profile does not transfer to it: identity, purity and actual content are separate questions from pharmacology, and no rate table can speak to them." },
    ],
    whereToBuy: { compoundSlug: "tirzepatide" },
  },
  {
    slug: "how-is-tirzepatide-dosed",
    category: "dosing",
    question: "How is tirzepatide dosed?",
    title: "How Is Tirzepatide Dosed? The Labelled 2.5–15 mg Ladder",
    metaDescription:
      "The FDA labels start at 2.5 mg once weekly and increase in 2.5 mg increments after at least four weeks, to a maximum of 15 mg. Mounjaro carries a separate 10 mg pediatric ceiling, and the missed-dose rule is 4 days (96 hours). Verified against the labels.",
    searchTags: ["how is tirzepatide dosed","tirzepatide dosage","tirzepatide dose schedule","mounjaro dosage","zepbound dosage","tirzepatide titration","tirzepatide missed dose"],
    hubBlurb: "The labelled escalation ladder and its ceiling, why the steps are four weeks apart, and the missed-dose rule as the labels actually write it.",
    lede:
      "Tirzepatide’s dosing is simpler than semaglutide’s: both approved labels use one ladder. It starts at 2.5 mg subcutaneously once weekly and increases in 2.5 mg increments after at least four weeks at the current dose, to a maximum of 15 mg once weekly. Mounjaro sets a separate ceiling of 10 mg in pediatric patients.",
    body: [
      { kind: "heading", text: "The labelled ladder" },
      { kind: "p", text: "The 2.5 mg starting dose is an initiation dose rather than a therapeutic one — it exists to let tolerance develop before the ladder begins in earnest. From there the labels increase in 2.5 mg increments after at least four weeks at the current step, giving the familiar 2.5 → 5 → 7.5 → 10 → 12.5 → 15 mg sequence over roughly twenty weeks. Because the increase is authorised only after at least four weeks, staying at a step longer sits inside the labelled schedule rather than departing from it." },
      { kind: "p", text: "The maximum is 15 mg once weekly for all indications on the Zepbound label. Mounjaro states the same 15 mg adult maximum alongside a separate 10 mg maximum in pediatric patients — a distinction easy to lose when a dose figure is quoted without its population." },
      { kind: "heading", text: "Why four weeks" },
      { kind: "p", text: "Tirzepatide’s half-life is approximately five days, so a weekly interval accumulates toward steady state rather than reaching it immediately; roughly four weeks at a given step is what it takes to get there. That is the pharmacological reason each rung is four weeks long, and it is also why escalating faster changes the tolerability picture without reaching a different destination. The published rationale for titration across this class is that starting high raises gastrointestinal adverse-event rates without improving outcomes." },
      { kind: "heading", text: "The missed-dose rule as written" },
      { kind: "p", text: "Both labels state it identically: administer as soon as possible within 4 days (96 hours) after the missed dose; if more than 4 days have passed, skip it and administer the next dose on the regularly scheduled day. This is reported because it is what the labels say, and it is worth noting that it differs from every semaglutide label — a rule learned from one product in this class does not transfer to another." },
      { kind: "cta", text: "To convert any of these milligram figures into syringe units for a given vial and volume, use the", href: "/calculator", label: "dosage calculator" },
    ],
    whereToBuy: { compoundSlug: "tirzepatide" },
  },
  {
    slug: "how-much-bac-water-for-tirzepatide",
    category: "injection",
    question: "How much bacteriostatic water for tirzepatide?",
    title: "How Much Bacteriostatic Water for Tirzepatide? Reconstitution Math",
    metaDescription:
      "Any volume works — the water sets the concentration and the concentration sets the syringe units. A reference table for the 10 mg, 30 mg and 60 mg vials across the labelled 2.5–15 mg ladder, with the arithmetic shown.",
    searchTags: ["how much bac water for tirzepatide","tirzepatide reconstitution","tirzepatide bacteriostatic water","reconstitute tirzepatide 30mg","tirzepatide 60mg reconstitution","tirzepatide units calculator"],
    hubBlurb: "The volume-to-concentration-to-units arithmetic for the 10, 30 and 60 mg vials, tabulated against the labelled ladder — including where a vial cannot hold a dose at all.",
    lede:
      "There is no correct volume. The water is a solvent that sets the concentration, and the concentration sets how many syringe units a milligram figure measures out to. What does matter with tirzepatide is vial capacity: the labelled ladder runs to 15 mg, so a 10 mg vial cannot supply the upper steps at any volume.",
    body: [
      { kind: "heading", text: "Why any volume works — and where that stops being true" },
      { kind: "p", text: "More liquid spreads the same fixed mass of powder further, so a given milligram figure occupies more of the barrel while the quantity drawn is untouched — nothing is weakened and nothing is diluted in any sense that changes what enters the syringe. The constraint that does bite is capacity rather than volume: no amount of water lets a 10 mg vial supply a 12.5 mg dose, which is why the table below marks those cells instead of computing a number for them." },
      { kind: "heading", text: "Reference table: volume, concentration, and syringe units" },
      { kind: "table",
        caption: "Units on a 100-unit (1 mL) insulin syringe. The dose points are the labelled escalation steps, listed because they are the figures the approved schedule uses — not as a recommendation to use any of them. 10, 30 and 60 mg are the vial sizes most commonly listed.",
        headers: ["Vial + water", "Concentration", "2.5 mg", "5 mg", "7.5 mg", "10 mg", "12.5 mg", "15 mg"],
        rows: [
          ["10 mg + 1 mL", "10 mg/mL", "25 units", "50 units", "75 units", "100 units", "—", "—"],
          ["30 mg + 1.5 mL", "20 mg/mL", "12.5 units", "25 units", "37.5 units", "50 units", "62.5 units", "75 units"],
          ["30 mg + 3 mL", "10 mg/mL", "25 units", "50 units", "75 units", "100 units", "over 100", "over 100"],
          ["60 mg + 3 mL", "20 mg/mL", "12.5 units", "25 units", "37.5 units", "50 units", "62.5 units", "75 units"],
        ],
        note: "— marks a dose larger than the vial holds. “Over 100” marks a measurement exceeding one 100-unit syringe, which means drawing twice. The arithmetic is: units = (dose in mg ÷ concentration in mg/mL) × 100.",
      },
      { kind: "cta", text: "To run these figures for a vial size or volume not tabulated here, use the", href: "/calculator", label: "dosage calculator" },
      { kind: "heading", text: "Bacteriostatic versus sterile water" },
      { kind: "p", text: "The distinction between the two waters is one ingredient — 0.9% benzyl alcohol, present in the bacteriostatic form and absent from the sterile one — and it decides how many openings a vial tolerates rather than anything about the peptide. Tirzepatide sits at the far end of that: a 60 mg vial covers a long stretch of the labelled ladder, so it is opened repeatedly over months. A preservative matters in proportion to how often a stopper is pierced, which is why the choice is more consequential for a large vial than for a small one." },
    ],
    whereToBuy: { compoundSlug: "tirzepatide" },
  },
  {
  ...
  {
    slug: "what-is-bpc-157-used-for",
    category: "uses",
    question: "What is BPC-157 used for?",
    title: "What Is BPC-157 Used For? What the Animal Studies Actually Examined",
    metaDescription:
      "No completed Phase 2 or 3 trial exists for any BPC-157 application. What exists is a large animal literature in specific injury models — Achilles transection, NSAID gastric lesions, sciatic nerve crush — plus one registered Phase 1 with no published results.",
    searchTags: ["what is bpc-157 used for","bpc 157 uses","what does bpc-157 do","bpc-157 healing","bpc-157 tendon","bpc-157 gut","is bpc-157 proven"],
    hubBlurb: "The specific injury models the research examined, what a rodent model can and cannot establish, and how a tendon study in rats became “the healing peptide”.",
    lede:
      "No completed Phase 2 or Phase 3 trial exists for any BPC-157 application. What does exist is a substantial animal literature, and it is more specific than the summaries suggest: it examines named injury models — transected Achilles tendon, NSAID-induced gastric lesions, crushed sciatic nerve — rather than healing in general.",
    body: [
      { kind: "heading", text: "What the literature actually examined" },
  ...
  {
    slug: "how-is-bpc-157-dosed",
    category: "dosing",
    question: "How is BPC-157 dosed?",
    title: "How Is BPC-157 Dosed? No Trial Set One — Where the Figures Come From",
    metaDescription:
      "No human trial established a BPC-157 dose. The 250 and 500 mcg figures in circulation are community convention extrapolated from animal work at 2.5–3.75 mcg/kg. What that extrapolation assumes, and why the half-life complicates it.",
    searchTags: ["how is bpc-157 dosed","bpc 157 dosage","bpc-157 250 mcg","bpc-157 dose","how much bpc-157","bpc-157 mcg per kg","bpc-157 protocol"],
    hubBlurb: "Why no trial-established dose exists, where the 250 and 500 mcg figures actually came from, and what the species extrapolation behind them assumes.",
    lede:
    ...
    body: [
      { kind: "heading", text: "Where the convention figures came from" },
      { kind: "p", text: "The animal research literature generally works at 2.5–3.75 mcg per kilogram twice daily. Applied to an adult human body weight that arithmetic lands somewhere around 300–400 mcg per day, which is the neighbourhood the commonly cited 250 and 500 mcg figures occupy. So the convention is not arbitrary — it is a species extrapolation, and knowing that is more useful than either accepting the number or dismissing it." },
      { kind: "p", text: "What the extrapolation assumes is the part worth examining. Scaling a dose from rat to human by body weight alone assumes comparable absorption, distribution, metabolism and clearance between the species, and comparable sensitivity at the receptor. Regulatory pharmacology generally uses body-surface-area scaling rather than a straight per-kilogram conversion precisely because the simple version tends to overshoot. Nobody has run the study that would settle which applies here." },
      { kind: "heading", text: "The half-life complication" },
      { kind: "p", text: "Plasma half-life is under 30 minutes, which on its own would imply a compound cleared long before any daily interval could matter. The reported biological effects nonetheless outlast plasma clearance, and the usual explanation is local tissue activity and downstream changes in gene expression rather than circulating concentration. That explanation is plausible and it is not established. It also means the ordinary logic connecting half-life to dosing interval — the logic that makes weekly incretin dosing coherent — does not straightforwardly apply, so the frequency conventions are not derivable from the pharmacokinetics either." },
      { kind: "heading", text: "Route, and why it splits by application" },
      { kind: "p", text: "Two routes appear in the literature and in practice. Subcutaneous injection is used in the musculoskeletal work, and localised injection near the injury site is reported as more effective than a distant site in those models. Oral administration appears in the gastrointestinal work, and it is coherent there for a specific reason: BPC-157's stability in gastric acid lets it reach gut tissue intact. The split is not a preference — it follows the tissue being studied." },
      { kind: "heading", text: "What an honest answer looks like" },
      { kind: "p", text: "An answer here has to carry two things at once: that the trial record fixes no figure, and what the circulating figures are together with where they came from. Both halves are load-bearing. Give only the absence and a reader who meets 250 mcg on the next site has no way to place it; give only the number and it acquires an authority no study ever conferred on it." },
      { kind: "cta", text: "To convert any of these microgram figures into syringe units for a given vial and volume, use the", href: "/calculator", label: "dosage calculator" },
    ],
    whereToBuy: { compoundSlug: "bpc-157" },
  },
  {
    slug: "what-are-the-side-effects-of-bpc-157",
    category: "side-effects",
    question: "What are the side effects of BPC-157?",
    title: "BPC-157 Side Effects: Why No Characterised Human Profile Exists",
    metaDescription:
      "No completed human safety trial has characterised BPC-157's side-effect profile. Animal work across three decades has not identified a toxic dose, which is a different claim from human safety — and the angiogenesis question remains open.",
    searchTags: ["bpc-157 side effects","is bpc-157 safe","bpc 157 safety","does bpc-157 cause cancer","bpc-157 long term effects","bpc-157 risks","bpc-157 tumor"],
    hubBlurb: "Why there is no characterised human side-effect profile, what “no toxic dose identified” does and does not mean, and the angiogenesis question the literature leaves open.",
    lede:
      "No completed human safety trial has characterised BPC-157's side-effect profile, so there are no reported rates to give. Animal studies across roughly three decades have not identified a toxic dose in the species tested. That is a meaningful finding and it is not the same claim as human safety — the two get conflated constantly, and separating them is most of the answer.",
    body: [
      { kind: "heading", text: "Why there are no rates on this page" },
      { kind: "p", text: "Side-effect rates come from systematic collection during controlled trials: a defined population, a defined exposure, and adverse events recorded whether or not anyone thought to look for them. BPC-157 has no completed trial of that kind. Any percentage attached to it would therefore be built from what people volunteered about themselves, and that source has a specific blind spot — it captures what a person noticed and connected to the compound, which excludes anything too gradual, too quiet, or too rare to stand out against ordinary life. Other pages on this site carry rate tables because named trials produced them. This one does not, and borrowing the format without the evidence behind it would be the more misleading choice." },
      { kind: "heading", text: "What “no toxic dose identified” actually establishes" },
      { kind: "p", text: "The animal toxicology record is genuinely unusual: across roughly thirty years of study, researchers have not identified a toxic dose in the tested species. That is worth reporting plainly. What it establishes is that acute toxicity did not appear in those animals at the doses examined. What it does not establish is a human safety profile, because the questions that matter most — effects over years, effects in people with existing disease, interactions — are not the questions an acute animal toxicology study asks." },
      { kind: "p", text: "Absence of a finding is also sensitive to what was measured. A study designed to detect acute toxicity is not designed to detect a slow one, and reading its silence as an all-clear extends the result past what it covered." },
      { kind: "heading", text: "What users report" },
      { kind: "p", text: "The commonly reported effects are mild and local: injection-site redness or irritation that resolves within hours, occasional mild dizziness in the early period, and inconsistent reports of mild headache. These come from user report rather than trial collection, which is why they are described here as reports rather than rates. The consistent thread is that no systemic effect appears reliably enough across sources to characterise." },
      { kind: "heading", text: "The angiogenesis question, stated precisely" },
      { kind: "p", text: "Part of BPC-157's proposed mechanism involves promoting new blood-vessel growth, and that raises a theoretical question about whether it could support the growth of an existing tumour. The published animal and human literature contains no reports of this occurring. It also contains no study designed to look for it — the research measured wound healing and tissue repair, not malignancy risk. So the question is open rather than answered, and it is open in both directions: the absence of reports is not evidence of absence when nothing was measuring." },
      { kind: "heading", text: "What the regulatory position adds, and what it does not" },
      { kind: "p", text: "BPC-157 was placed in Category 2 of the FDA's bulk drug substances list in 2023 — the significant-safety-concern category, which bars compounding pharmacies from preparing it. Its subsequent history is procedural rather than substantive: it was technically removed from Category 2 when the original nominators withdrew, then renominated through a different pathway. Removal from Category 2 does not authorise compounding and does not place a substance in Category 1. The category placement reflects a regulatory judgement made largely on the absence of adequate safety data, so it is better read as another statement of that absence than as an independent finding about the molecule." },
      { kind: "heading", text: "What none of this covers" },
      { kind: "p", text: "Everything above concerns the molecule. A vial sold on the research market raises separate questions — identity, purity, and what else is in it — that no amount of pharmacology speaks to, and that are the more immediate variable where no approval process stands behind the contents." },
    ],
    whereToBuy: { compoundSlug: "bpc-157" },
  },
  {
