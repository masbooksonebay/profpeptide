...
export default function Endo2026Glp1RecapJune2026Page() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "News", path: "/news" }, { name: "ENDO 2026 Recap — GLP-1 and Peptide Readouts from the Endocrine Society Meeting" }])} />
      ...
      <div className="section max-w-3xl">
        ...
        <div className="space-y-6 text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">Physical Activity Fell After Starting a GLP-1 &mdash; the Muscle-Preservation Angle</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">GLP-1s and Male Fertility &mdash; No Long-Term Harm, Possible Benefit</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">CagriSema Meta-Analysis (Abstract SUN-726)</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">Real-World Adherence &mdash; GLP-1 Use Is More Start-and-Stop Than Assumed</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">Entera Bio &mdash; Preclinical Oral Peptides (EB618 and EB612)</h2>
          <p>
