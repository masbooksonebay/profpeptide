...
export default function RetatrutidePhase3UpdateMay2026Page() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "News", path: "/news" }, { name: "Retatrutide Phase 3 Update — Diabetes and Osteoarthritis Trials Hit Primary Endpoints" }])} />
