...
export default function FDA503BGLP1BulkCompounding2026Page() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "News", path: "/news" }, { name: "FDA Moves to Bar Outsourcing Facilities From Bulk-Compounding Semaglutide, Tirzepatide, and Liraglutide" }])} />
      ...
      <div className="section max-w-3xl">
        ...
        <div className="border-l-4 border-[#3A759F] pl-4 py-1 mb-6 text-sm leading-relaxed">
