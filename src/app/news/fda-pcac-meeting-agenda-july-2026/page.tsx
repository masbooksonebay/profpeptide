...
export default function FDAPcacMeetingAgendaJuly2026Page() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "News", path: "/news" }, { name: "FDA Releases Official Agenda for July Peptide Compounding Meeting" }])} />
      ...
      <div className="section max-w-3xl">
        ...
        <div className="space-y-6 text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">What the Federal Register Notice Says</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">Day 1 &mdash; July 23, 2026</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">Day 2 &mdash; July 24, 2026</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">What About the Other Restricted Peptides?</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">How the Public Comment Process Works</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">What Happens After the Meeting</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 pt-2">Why This Matters for the Research Community</h2>
          <p>
