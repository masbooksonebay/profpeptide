...
const trust = [
  ...
  { value: "Verified", label: "Supplier codes" },
];
    ...
    <>
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
          <span className="tag mb-5 inline-block">Research Education Platform</span>
          <h1 className="text-4xl sm:text-5xl font-bold text-[#1e2d3d] leading-tight mb-5">
            The research guide for<br className="hidden sm:block" /> serious peptide scientists
          </h1>
          <p className="text-lg text-gray-500 max-w-xl mx-auto mb-8 leading-relaxed">
            Evidence-based peptide education, precision dosage tools, and curated supplier codes — all in one independent, clinical-grade resource.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/peptides" className="btn-primary text-base px-8 py-3.5">Explore Peptide Library</Link>
      ...
      <div className="bg-[#f0fafa] border-b border-[#d0eeef] py-3 px-4 text-center">
        <p className="text-xs text-[#0D7377] max-w-2xl mx-auto">
          <strong>Educational use only.</strong> Prof. Peptide is an independent research education platform. Nothing here constitutes medical advice or endorses human use of research peptides.
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-600">
                {[
                  "No vendor affiliation — only independently verified information",
                  "Every peptide profile cites primary research literature",
                  "Calculator math is transparent and peer-reviewable",
                  "Coupon codes are manually tested before publishing",
                ].map((item) => (
