...
// Publicly discoverable price-comparison pages: indexable === true excludes the
// noindexed sub-3-vendor compounds. Derived from src/data/prices.index.json so
// it tracks vendor additions (that file is the real number, regenerated by the
// price-pull build).
