      ...
      <div className="section max-w-3xl">
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
              Prof. Peptide is supported by affiliate commissions from the vendors we list. The codes on this site {/* codes:disclosure — generic illustrative list, not a per-vendor code; exempt from check:codes Tier 3 */}(PROFPEPTIDE, PROF20, and others) give you a discount and pay us a commission when used. Vendors are selected and ranked based on verified COA transparency, purity standards, and fulfillment reliability &mdash; independently of commission rates.
            </p>
          </section>
        </div>
