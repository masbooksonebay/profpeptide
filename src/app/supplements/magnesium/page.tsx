...
export default function MagnesiumPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Magnesium","description":"Magnesium supplement profile covering 300+ enzymatic reactions, sleep quality, blood pressure, glycinate vs citrate forms, and optimal dosage.","url":"https://profpeptide.com/supplements/magnesium","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Magnesium"}]}} />
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ol className="list-decimal list-inside space-y-1">
            {["Zhang X, et al. Effects of magnesium supplementation on blood pressure: a meta-analysis of randomized double-blind placebo-controlled trials. Hypertension. 2016.","Abbasi B, et al. The effect of magnesium supplementation on primary insomnia in elderly: a double-blind placebo-controlled clinical trial. J Res Med Sci. 2012."].map((ref, i) => (<li key={i} className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">{ref}</li>))}
          </ol>
        </div>
      </div>
