...
export default function NADPlusSupplementPage() {
  return (
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 mb-2">Also Known As: Nicotinamide Adenine Dinucleotide, NAD, Coenzyme I. Precursors: NMN (Nicotinamide Mononucleotide), NR (Nicotinamide Riboside)</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">The essential coenzyme behind cellular energy, DNA repair, and longevity</p>

      <div className="space-y-8">
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-2">📋 Overview</h2>
          <p className="text-sm text-gray-600 leading-relaxed">NAD+ (Nicotinamide Adenine Dinucleotide) is a coenzyme found in every living cell, essential to energy metabolism, DNA repair, and cellular signaling. NAD+ levels decline significantly with age — by middle age, levels may be roughly half of what they were in youth. This decline is associated with reduced cellular energy production, impaired DNA repair, and increased vulnerability to age-related disease. Rather than supplementing NAD+ directly (which has poor bioavailability), most protocols use NAD+ precursors — primarily NMN (Nicotinamide Mononucleotide) and NR (Nicotinamide Riboside) — which the body converts into NAD+.</p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 leading-relaxed">NMN and NR are generally well tolerated in clinical trials. Common mild side effects include nausea and flushing at higher doses. Note: The FDA ruled in 2023 that NMN cannot be sold as a dietary supplement (it was filed as an investigational drug), though it remains widely available. NR remains available as a supplement. Long-term safety data in humans is still accumulating. Consult a healthcare provider before use.</p>
        </div>

        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-3">🔗 Related Supplements</h2>
          <p className="text-sm text-gray-600"><Link href="/supplements/nmn" className="text-[#0D7377] hover:underline">NMN</Link> | <Link href="/supplements/resveratrol" className="text-[#0D7377] hover:underline">Resveratrol</Link> | <Link href="/supplements/coq10" className="text-[#0D7377] hover:underline">CoQ10</Link> | <Link href="/supplements/quercetin" className="text-[#0D7377] hover:underline">Quercetin</Link></p>
        </div>
      ...
      <div className="mt-10 p-5 bg-gray-50 border border-gray-100 rounded-xl">
        <p className="text-sm font-medium text-gray-700 mb-1">Read the full NAD+ research</p>
