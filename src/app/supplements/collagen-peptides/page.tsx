...
export const metadata = {
  title: "Collagen Peptides Supplement Profile | Prof. Peptide",
  description:
    "Collagen peptides supplement profile — joint pain reduction, skin elasticity, tendon support, vitamin C synergy, dosing, and references.",
};
...
export default function CollagenPeptidesPage() {
  return (
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 mb-2">Also Known As: Hydrolyzed collagen, collagen hydrolysate, bovine collagen, marine collagen</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">The building block your joints, skin, and connective tissue are literally made of</p>
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "⏱️ Exercise timing: For tendon and joint benefit, take 30–60 minutes before exercise",
              "☀️ Skin: Consistent daily use for 8–12 weeks to see skin improvements",
            ].map((item, i) => (
              <li key={i} className="text-sm text-gray-600 leading-relaxed">{item}</li>
            ))}
          </ul>
