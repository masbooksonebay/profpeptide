...
export default function CoQ10Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"CoQ10","description":"CoQ10 supplement profile covering mitochondrial electron transport, heart failure research, statin myopathy support, and ubiquinol vs ubiquinone.","url":"https://www.profpeptide.com/supplements/coq10","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"CoQ10"}]}} />
