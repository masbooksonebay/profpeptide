  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Garcinia Cambogia 🔥</h1>
        <span className="tag">Metabolic &amp; Weight Loss</span>
      </div>
      <p className="text-sm text-gray-500 mb-2">Also Known As: HCA, hydroxycitric acid, Malabar tamarind, Garcinia gummi-gutta</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">The tropical fruit extract once heralded as a weight loss breakthrough</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {[
              "🍽️ Mild appetite suppression via serotonin modulation",
              "🚫 ATP citrate lyase inhibition reducing fat synthesis",
              "⚖️ Modest weight loss in some studies",
              "🛡️ May reduce belly fat accumulation",
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "⚠️ Note: Effects are modest — best viewed as complementary to diet and exercise",
            ].map((item, i) => (
              <li key={i} className="text-sm text-gray-600 leading-relaxed">{item}</li>
            ))}
          </ul>
