  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Curcumin 🔥⚡</h1>
        <span className="tag">Recovery &amp; Tissue Repair</span>
      </div>
      <p className="text-sm text-gray-500 mb-2">Also Known As: Turmeric extract, diferuloylmethane, BCM-95, Meriva, Theracurmin</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">Nature&apos;s most powerful anti-inflammatory compound — if you can absorb it</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {[
              "🛡️ Powerful anti-inflammatory — comparable to NSAIDs in some studies",
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "🌶️ With piperine: Black pepper extract (piperine, BioPerine) increases curcumin absorption by up to 2000%",
              "🍽️ With fat: Curcumin is fat-soluble — take with a fatty meal for better absorption",
