...
export default function CurcuminPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Curcumin","description":"Curcumin supplement profile covering NF-κB inhibition, anti-inflammatory effects, joint pain relief, bioavailability solutions, and dosage.","url":"https://www.profpeptide.com/supplements/curcumin","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Curcumin"}]}} />
