...
export default function BiotinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Biotin","description":"Biotin (vitamin B7) profile covering nail strength evidence, hair support in deficiency, keratin mechanism, and lab test interference warning.","url":"https://www.profpeptide.com/supplements/biotin","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Biotin"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Vitamin B7, vitamin H, coenzyme R</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The B vitamin behind stronger hair, nails, and healthy skin</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300"><Link href="/supplements/collagen-peptides" className="text-[#0891b2] hover:underline">Collagen Peptides</Link> | <Link href="/supplements/hyaluronic-acid" className="text-[#0891b2] hover:underline">Hyaluronic Acid</Link> | <Link href="/supplements/vitamin-c" className="text-[#0891b2] hover:underline">Vitamin C</Link> | <Link href="/supplements/zinc" className="text-[#0891b2] hover:underline">Zinc</Link></p>
        </div>
      ...
      <div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=biotin+supplement&tag=profpeptide-20"
          target="_blank"
