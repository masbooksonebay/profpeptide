  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Vitamin C ⚡✨</h1>
        <span className="tag">Recovery &amp; Tissue Repair</span>
      </div>
      <p className="text-sm text-gray-500 mb-2">Also Known As: Ascorbic acid, ascorbate, L-ascorbic acid</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">The essential vitamin your body can&apos;t make — critical for collagen and immunity</p>
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "⚠️ High dose caution: Doses above 2000mg daily may cause GI upset and diarrhea; very high doses may interfere with training adaptations by blunting oxidative stress signals that drive adaptation",
            ].map((item, i) => (
              <li key={i} className="text-sm text-gray-600 leading-relaxed">{item}</li>
            ))}
          </ul>
