...
export default function ProteinPowderPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Protein Powder","description":"Protein powder profile covering muscle protein synthesis, whey vs casein vs plant sources, optimal intake, and post-workout timing.","url":"https://www.profpeptide.com/supplements/protein-powder","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Protein Powder"}]}} />
