...
export default function ZMAPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"ZMA","description":"ZMA supplement profile covering zinc magnesium aspartate, sleep quality improvement, testosterone support in athletes, and mineral repletion.","url":"https://www.profpeptide.com/supplements/zma","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"ZMA"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Zinc magnesium aspartate, zinc monomethionine aspartate, ZMA-5</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The sleep and recovery stack trusted by athletes for decades</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300"><Link href="/supplements/ashwagandha" className="text-[#0891b2] hover:underline">Ashwagandha</Link> | <Link href="/supplements/gaba" className="text-[#0891b2] hover:underline">GABA</Link> | <Link href="/supplements/l-arginine" className="text-[#0891b2] hover:underline">L-Arginine</Link> | <Link href="/supplements/magnesium" className="text-[#0891b2] hover:underline">Magnesium</Link></p>
        </div>
      ...
      <div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=ZMA+supplement&tag=profpeptide-20"
          target="_blank"
