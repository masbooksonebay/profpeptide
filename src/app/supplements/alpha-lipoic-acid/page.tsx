...
export default function AlphaLipoicAcidPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Alpha Lipoic Acid","description":"Alpha lipoic acid profile covering universal antioxidant mechanism, diabetic neuropathy evidence, insulin sensitivity, and R-ALA vs S-ALA forms.","url":"https://profpeptide.com/supplements/alpha-lipoic-acid","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Alpha Lipoic Acid"}]}} />
