...
const breadcrumbSchema = breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Supplements", path: "/supplements" }, { name: "Berberine" }]);
  ...
  return (
    ...
    <div className="section max-w-3xl">
      ...
      <div className="mt-6 p-5 border border-[#3A759F]/20 bg-[#3A759F]/10 rounded-xl">
        ...
        <div className="flex flex-wrap gap-4">
          <NavLink href="/compare/berberine-vs-metformin" className="text-sm font-medium text-[#3A759F] hover:underline">Berberine vs Metformin</NavLink>
        </div>
      </div>
