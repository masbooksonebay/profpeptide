...
export default function BerberinePage() {
  return (
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Berberine HCl, berberine hydrochloride</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The plant-based metabolic powerhouse often compared to metformin</p>
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "⏱Timing: With or immediately before meals to blunt post-meal blood sugar spikes",
