...
export default function AshwagandhaPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Ashwagandha","description":"Ashwagandha supplement profile covering cortisol reduction, testosterone support, KSM-66 evidence, muscle strength, and sleep quality.","url":"https://www.profpeptide.com/supplements/ashwagandha","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Ashwagandha"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Withania somnifera, Indian ginseng, winter cherry, KSM-66, Sensoril</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The ancient adaptogen that reduces cortisol, raises testosterone, and builds resilience</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300"><Link href="/supplements/rhodiola-rosea" className="text-[#0891b2] hover:underline">Rhodiola Rosea</Link> | <Link href="/supplements/l-theanine" className="text-[#0891b2] hover:underline">L-Theanine</Link> | <Link href="/supplements/zma" className="text-[#0891b2] hover:underline">ZMA</Link> | <Link href="/supplements/magnesium" className="text-[#0891b2] hover:underline">Magnesium</Link></p>
        </div>
      ...
      <div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=ashwagandha+KSM-66&tag=profpeptide-20"
          target="_blank"
