      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 mb-3">
            ...
            <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">Disclose the form (immediate-release vs. extended-release — these have different use cases)</li>
            <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">Are produced in cGMP-certified facilities</li>
            <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">Avoid unnecessary additives, dyes, or proprietary blends</li>
          </ul>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
