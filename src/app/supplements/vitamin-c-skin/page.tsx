...
export default function VitaminCSkinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Vitamin C for Skin","description":"Vitamin C for skin profile covering collagen hydroxylation, melanin inhibition, UV protection, vitamin E regeneration, and dosage.","url":"https://profpeptide.com/supplements/vitamin-c-skin","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Vitamin C for Skin"}]}} />
    <div className="section max-w-3xl">
      ...
      <PageDisclaimer />
    <ContactLink pageName="Vitamin C" pagePath="/supplements/vitamin-c-skin" />
    </div>
    </>
  );
}
