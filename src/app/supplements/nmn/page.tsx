...
const breadcrumbSchema = breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Supplements", path: "/supplements" }, { name: "NMN" }]);
  ...
  return (
    ...
    <div className="section max-w-3xl">
      ...
      <div className="mt-6 p-5 border border-[#3A759F]/20 bg-[#3A759F]/10 rounded-xl">
        ...
        <div className="flex flex-wrap gap-4">
          <NavLink href="/compare/nmn-vs-niacin" className="text-sm font-medium text-[#3A759F] hover:underline">NMN vs Niacin</NavLink>
          <NavLink href="/compare/nmn-vs-nr-vs-niacin" className="text-sm font-medium text-[#3A759F] hover:underline">NMN vs NR vs Niacin</NavLink>
        </div>
      </div>
