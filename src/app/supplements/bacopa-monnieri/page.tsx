    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600"><Link href="/supplements/lions-mane" className="text-[#0D7377] hover:underline">Lion&apos;s Mane</Link> | <Link href="/supplements/alpha-gpc" className="text-[#0D7377] hover:underline">Alpha GPC</Link> | <Link href="/supplements/phosphatidylserine" className="text-[#0D7377] hover:underline">Phosphatidylserine</Link> | <Link href="/supplements/rhodiola-rosea" className="text-[#0D7377] hover:underline">Rhodiola Rosea</Link></p>
        </div>
