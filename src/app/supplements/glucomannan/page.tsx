  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Glucomannan 🔥</h1>
        <span className="tag">Metabolic &amp; Weight Loss</span>
      </div>
      <p className="text-sm text-gray-500 mb-2">Also Known As: Konjac fiber, konjac glucomannan, KGM</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">The viscous fiber that makes you feel full and slows sugar absorption</p>
