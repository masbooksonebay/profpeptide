...
export default function RhodiolaRoseaPage() {
  return (
    ...
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Arctic root, golden root, roseroot, SHR-5, rosavins</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The adaptogen that fights fatigue and sharpens performance under stress</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300"><Link href="/supplements/ashwagandha" className="text-[#0891b2] hover:underline">Ashwagandha</Link> | <Link href="/supplements/l-theanine" className="text-[#0891b2] hover:underline">L-Theanine</Link> | <Link href="/supplements/bacopa-monnieri" className="text-[#0891b2] hover:underline">Bacopa Monnieri</Link> | <Link href="/supplements/lions-mane" className="text-[#0891b2] hover:underline">Lion&apos;s Mane</Link></p>
        </div>
      ...
      <div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=rhodiola+rosea&tag=profpeptide-20"
          target="_blank"
