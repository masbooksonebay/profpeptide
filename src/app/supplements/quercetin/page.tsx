...
export default function QuercetinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Quercetin","description":"Quercetin supplement profile covering senolytic activity, NF-κB inhibition, zinc ionophore mechanism, and Mayo Clinic aging research.","url":"https://www.profpeptide.com/supplements/quercetin","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Quercetin"}]}} />
