    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ol className="list-decimal list-inside space-y-1">
            {["Anderson RA, et al. Elevated intakes of supplemental chromium improve glucose and insulin variables in individuals with type 2 diabetes. Diabetes. 1997.","Tian H, et al. Chromium picolinate supplementation for overweight or obese adults. Cochrane Database Syst Rev. 2013."].map((ref, i) => (<li key={i} className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">{ref}</li>))}
          </ol>
        </div>
      </div>
