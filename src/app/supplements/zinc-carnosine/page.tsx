...
export const metadata = {
  title: "Zinc Carnosine Supplement Profile | Prof. Peptide",
  description:
    "Zinc carnosine supplement profile — gut mucosal repair, ulcer healing, leaky gut support, athlete gut health, dosing, and references.",
};
  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Zinc Carnosine ⚡🛡️</h1>
        <span className="tag">Recovery &amp; Tissue Repair</span>
      </div>
      <p className="text-sm text-gray-500 mb-2">Also Known As: Polaprezinc, zinc L-carnosine, ZnC, PepZin GI</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">The gut-healing compound trusted by gastroenterologists for decades</p>
