...
export default function ZincPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Zinc","description":"Zinc supplement profile covering immune cell development, cold duration reduction, gut barrier support, testosterone, and form comparison.","url":"https://profpeptide.com/supplements/zinc","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Zinc"}]}} />
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ol className="list-decimal list-inside space-y-1">
            {["Singh M, Das RR. Zinc for the common cold. Cochrane Database Syst Rev. 2013.","Prasad AS. Zinc in human health: effect of zinc on immune cells. Mol Med. 2008."].map((ref, i) => (<li key={i} className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">{ref}</li>))}
          </ol>
        </div>
      </div>
