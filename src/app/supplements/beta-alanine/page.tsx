...
export default function BetaAlaninePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Beta-Alanine","description":"Beta-alanine supplement profile covering carnosine synthesis, pH buffering, fatigue delay in 1-4 minute exercise, and paraesthesia management.","url":"https://www.profpeptide.com/supplements/beta-alanine","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Beta-Alanine"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: CarnoSyn, beta-alanine anhydrous, BA</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The tingling amino acid that delays muscle fatigue in the 1–4 minute zone</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300"><Link href="/supplements/creatine" className="text-[#0891b2] hover:underline">Creatine</Link> | <Link href="/supplements/bcaas" className="text-[#0891b2] hover:underline">BCAAs</Link> | <Link href="/supplements/electrolyte-powders" className="text-[#0891b2] hover:underline">Electrolyte Powders</Link> | <Link href="/supplements/caffeine-l-theanine" className="text-[#0891b2] hover:underline">Caffeine + L-Theanine</Link></p>
        </div>
