    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ol className="list-decimal list-inside space-y-1">
            {["Baur JA, Sinclair DA. Therapeutic potential of resveratrol: the in vivo evidence. Nat Rev Drug Discov. 2006.","Hausenblas HA, et al. Resveratrol treatment as an adjunct to pharmacological management in type 2 diabetes mellitus — systematic review and meta-analysis. Mol Nutr Food Res. 2015."].map((ref, i) => (<li key={i} className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">{ref}</li>))}
          </ol>
        </div>
      </div>
