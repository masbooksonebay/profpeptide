  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Green Tea Extract 🔥</h1>
        <span className="tag">Metabolic &amp; Weight Loss</span>
      </div>
      <p className="text-sm text-gray-500 mb-2">Also Known As: EGCG, epigallocatechin gallate, GTE, Camellia sinensis extract</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">The ancient metabolism booster backed by modern science</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {[
              ...
              "❤️ Cardiovascular protection and LDL reduction",
              "🧠 Neuroprotective effects and cognitive support",
              "🛡️ Antioxidant protection — one of the highest ORAC values",
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "🍽️ Timing: With meals to reduce potential stomach irritation",
              "⚠️ Note: High doses on empty stomach can cause nausea",
            ].map((item, i) => (
              <li key={i} className="text-sm text-gray-600 leading-relaxed">{item}</li>
            ))}
          </ul>
