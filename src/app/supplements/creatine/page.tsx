...
export default function CreatinePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Creatine","description":"Creatine supplement profile covering phosphocreatine mechanism, strength and muscle gains, cognitive benefits, and monohydrate gold standard.","url":"https://www.profpeptide.com/supplements/creatine","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Creatine"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Creatine monohydrate, creatine HCl, buffered creatine</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The most researched performance supplement in history — and it works</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {[
              ...
              "Greater muscle mass gains from resistance training",
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "⏱Timing: Timing is flexible — post-workout with carbohydrates and protein may marginally improve uptake",
...
<div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=creatine+monohydrate&tag=profpeptide-20"
          target="_blank"
