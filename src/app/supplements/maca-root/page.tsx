...
export default function MacaRootPage() {
  return (
    ...
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Lepidium meyenii, Peruvian ginseng, maca powder, gelatinized maca</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The Andean adaptogen used for centuries to boost libido and fertility</p>

      <div className="space-y-8">
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] dark:text-slate-100 mb-2">Overview</h2>
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">Maca (Lepidium meyenii) is a cruciferous root vegetable native to the high-altitude plateaus of the Peruvian Andes, where it has been cultivated and consumed for over 2,000 years — both as a food staple and as a traditional remedy for enhancing fertility, libido, and energy. It is classified as an adaptogen and is unique among sexual health supplements in that it does not directly influence sex hormone levels — testosterone, estrogen, and LH remain unchanged in most clinical studies. Instead, maca appears to work through other mechanisms including neurotransmitter modulation, hypothalamic regulation, and direct effects on reproductive tissue. It is one of the few natural supplements with multiple human RCTs supporting improvements in sexual desire and function in both men and women, including postmenopausal women — a population with limited options for non-hormonal libido support. Different colored maca varieties (yellow, red, black) have subtly different bioactive profiles — black maca has the strongest evidence for male fertility and sperm parameters, while red maca has been studied for prostate health.</p>
        </div>
