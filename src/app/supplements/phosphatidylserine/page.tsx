...
export default function PhosphatidylserinePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Phosphatidylserine","description":"Phosphatidylserine profile covering FDA qualified health claim, neuronal membrane support, cortisol blunting, and memory improvement.","url":"https://www.profpeptide.com/supplements/phosphatidylserine","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Phosphatidylserine"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: PS, Sharp-PS, phosphatidyl serine</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The FDA-qualified brain phospholipid that supports memory and cortisol control</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300"><Link href="/supplements/alpha-gpc" className="text-[#0891b2] hover:underline">Alpha GPC</Link> | <Link href="/supplements/bacopa-monnieri" className="text-[#0891b2] hover:underline">Bacopa Monnieri</Link> | <Link href="/supplements/lions-mane" className="text-[#0891b2] hover:underline">Lion&apos;s Mane</Link> | <Link href="/supplements/fish-oil" className="text-[#0891b2] hover:underline">Omega-3 Fish Oil</Link></p>
        </div>
      ...
      <div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=phosphatidylserine&tag=profpeptide-20"
          target="_blank"
