...
export default function CollagenPeptidesSkinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Collagen Peptides for Skin","description":"Collagen peptides for skin profile covering fibroblast stimulation, wrinkle reduction, elasticity improvement, and vitamin C synergy.","url":"https://www.profpeptide.com/supplements/collagen-peptides-skin","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Collagen Peptides for Skin"}]}} />
