...
export default function CollagenPeptidesSkinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Collagen Peptides for Skin","description":"Collagen peptides for skin profile covering fibroblast stimulation, wrinkle reduction, elasticity improvement, and vitamin C synergy.","url":"https://profpeptide.com/supplements/collagen-peptides-skin","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Collagen Peptides for Skin"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Hydrolyzed collagen, collagen hydrolysate, marine collagen, bovine collagen</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">Rebuild your skin from the inside out</p>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300"><Link href="/supplements/vitamin-c" className="text-[#0891b2] hover:underline">Vitamin C</Link> | <Link href="/supplements/hyaluronic-acid" className="text-[#0891b2] hover:underline">Hyaluronic Acid</Link> | <Link href="/supplements/biotin" className="text-[#0891b2] hover:underline">Biotin</Link> | <Link href="/peptides/ghk-cu" className="text-[#0891b2] hover:underline">GHK-Cu peptide</Link></p>
        </div>
      ...
      <div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=collagen+peptides+skin&tag=profpeptide-20"
          target="_blank"
      ...
      <PageDisclaimer />
    <ContactLink pageName="Collagen Peptides" pagePath="/supplements/collagen-peptides-skin" />
    </div>
    </>
  );
}
