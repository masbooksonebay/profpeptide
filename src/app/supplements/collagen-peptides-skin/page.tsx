    ...
    <div className="section max-w-3xl">
      ...
      <div className="mb-8 p-4 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
          <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Also Known As:</span> Hydrolyzed collagen, collagen hydrolysate, marine collagen (Type I), bovine collagen (Type I + III), Pro-Hyp dipeptide
        </p>
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed pt-1">
          <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Supplement Class:</span> Hydrolyzed collagen peptide (Type I/III) / dermal fibroblast stimulator / amino-acid substrate for skin collagen synthesis
        </p>
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed pt-1">
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] dark:text-slate-100 mb-2">How do collagen peptides reach skin?</h2>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Absorption.</span> Hydrolyzed collagen is broken into small di- and tri-peptide fragments that absorb intact through gut epithelium — bypassing the breakdown to free amino acids that whole-protein digestion produces. The Pro-Hyp dipeptide (proline-hydroxyproline) and Hyp-Gly (hydroxyproline-glycine) are the dominant bioactive fragments documented in plasma after oral collagen peptide dosing.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Dermal accumulation.</span> Radioactive labeling studies have tracked absorbed collagen peptides specifically to skin tissue, confirming they accumulate in the dermis. This is not generic amino-acid recycling — the intact peptide fragments target skin preferentially.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Fibroblast signaling.</span> Pro-Hyp directly stimulates dermal fibroblasts to upregulate collagen, elastin, and hyaluronic acid synthesis. This is a signaling effect, not merely providing raw material — the dipeptide acts as a molecular trigger for collagen-production gene expression.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Substrate + signaling = output.</span> The collagen peptides provide both the upstream signal (Pro-Hyp activates fibroblasts) and the downstream substrate (proline, hydroxyproline, glycine — the three dominant amino acids in collagen). Vitamin C provides the obligate cofactor for the hydroxylation step. The triad is what produces measurable dermal collagen increase.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Meta-analysis (Strong).</span> de Miranda 2021 (Int J Dermatol) systematic review and meta-analysis of 19 RCTs involving 1,125 participants found oral collagen supplementation significantly improved skin elasticity, hydration, and reduced wrinkle scores versus placebo — with effects sustained beyond the supplementation period in several trials.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Proksch 2014 reference RCT.</span> A double-blind placebo-controlled trial of 2.5 g specific collagen peptides daily for 8 weeks in women aged 35–55. Significant improvements in skin elasticity vs placebo, with effects observable on 4-week interim measurements. The Proksch trial established that the lower-dose (2.5 g) protocol is effective for skin endpoints — meaningful for users seeking minimum-effective-dose protocols.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Women over 40 — consistent signal.</span> The cleanest skin evidence comes from women aged 40+ with established age-related collagen decline. Trials in this population consistently show improvements in skin moisture content, roughness, and elasticity after 8–12 weeks.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Cellulite and nail strength (secondary).</span> Smaller trials suggest reduced cellulite appearance with 6+ months of supplementation, and improved nail strength and growth. These are secondary use cases with thinner evidence than the elasticity/hydration/wrinkle endpoints.
          </p>
        </div>

        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] dark:text-slate-100 mb-2">How to use collagen peptides for skin</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] dark:text-slate-100 mb-2">What we don't know yet about collagen for skin</h2>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Specific peptide formulations.</span> Several patented collagen peptide formulations claim superior skin-specific bioavailability (Verisol, Peptan, etc.). Whether these meaningfully outperform generic hydrolyzed collagen at equivalent grams is mechanistically plausible but not rigorously head-to-head tested at scale.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Younger-adult skin transfer.</span> Most positive evidence is in women aged 35+. Whether oral collagen peptides produce meaningful skin benefit in healthy adults under 30 with intact endogenous collagen synthesis is less directly supported by trial data.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Dose-response above 10 g/day.</span> Most efficacy plateaus at the 2.5–10 g/day range; whether higher doses (15–20 g/day) add value or are wasted is poorly characterized.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Long-term skin maintenance.</span> Trial durations extend to 12 months. Multi-year continuous use is reasonable based on safety profile and mechanism but not directly RCT-characterized.
          </p>
        </div>

        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] dark:text-slate-100 mb-3">Collagen Peptides for Skin FAQ</h2>
