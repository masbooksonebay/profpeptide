    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">Three controlled trials anchor the evidence base:</p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed mb-3">
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-1 mb-3">
            ...
            <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">Have minimal additives — pure glycine powder is essentially flavorless to faintly sweet, no need for fillers or flavorings</li>
          </ul>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
