...
export default function CaffeinePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Caffeine","description":"Caffeine supplement profile covering adenosine antagonism, metabolic rate increase, fat oxidation, physical performance, and optimal dosage.","url":"https://www.profpeptide.com/supplements/caffeine","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Caffeine"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: 1,3,7-trimethylxanthine, anhydrous caffeine, caffeine anhydrous</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The world&apos;s most widely used psychoactive substance — and most research-backed</p>
        ...
        <div>
          ...
          <ul className="space-y-1">
            {[
              ...
              "⏱Timing: 30–60 minutes before exercise or when cognitive performance is needed",
...
<div className="mt-10 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <a
          href="https://www.amazon.com/s?k=caffeine+supplement&tag=profpeptide-20"
          target="_blank"
