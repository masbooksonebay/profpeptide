...
export default function AlphaGPCPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Alpha GPC","description":"Alpha GPC supplement profile covering choline bioavailability, acetylcholine synthesis, cognitive enhancement, and growth hormone release.","url":"https://www.profpeptide.com/supplements/alpha-gpc","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Alpha GPC"}]}} />
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 dark:text-slate-400 mb-2">Also Known As: Alpha-glycerophosphocholine, L-alpha glycerylphosphorylcholine, choline alfoscerate</p>
      <p className="text-sm text-[#0891b2] font-medium mb-8">The most bioavailable choline source for brain and performance</p>
