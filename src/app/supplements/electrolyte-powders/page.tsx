  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Electrolyte Powders</h1>
        <span className="tag">Performance &amp; Energy</span>
      </div>
      <p className="text-sm text-gray-500 mb-2">Also Known As: Electrolytes, sports drinks, hydration supplements, mineral supplements</p>
      <p className="text-sm text-[#0D7377] font-medium mb-8">Sweat smart — replenish what exercise takes away</p>
