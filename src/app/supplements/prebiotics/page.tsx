...
export default function PrebioticsPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Prebiotics","description":"Prebiotics supplement profile covering selective fermentation, butyrate production, Bifidobacterium growth, and synbiotic combination approach.","url":"https://www.profpeptide.com/supplements/prebiotics","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://www.profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://www.profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Prebiotics"}]}} />
