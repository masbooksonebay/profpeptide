...
export default function PrebioticsPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Prebiotics","description":"Prebiotics supplement profile covering selective fermentation, butyrate production, Bifidobacterium growth, and synbiotic combination approach.","url":"https://profpeptide.com/supplements/prebiotics","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://profpeptide.com"},{"@type":"ListItem","position":2,"name":"Supplements","item":"https://profpeptide.com/supplements"},{"@type":"ListItem","position":3,"name":"Prebiotics"}]}} />
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ol className="list-decimal list-inside space-y-1">
            {["Slavin J. Fiber and Prebiotics: Mechanisms and Health Benefits. Nutrients. 2013.","Roberfroid M, et al. Prebiotic effects: metabolic and health benefits. Br J Nutr. 2010."].map((ref, i) => (<li key={i} className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">{ref}</li>))}
          </ol>
        </div>
      </div>
