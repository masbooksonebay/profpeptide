    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <ol className="list-decimal list-inside space-y-1">
            {["Slavin J. Fiber and Prebiotics: Mechanisms and Health Benefits. Nutrients. 2013.","Roberfroid M, et al. Prebiotic effects: metabolic and health benefits. Br J Nutr. 2010."].map((ref, i) => (<li key={i} className="text-sm text-gray-600 leading-relaxed">{ref}</li>))}
          </ol>
        </div>
      </div>

      <div className="flex flex-wrap gap-2 mt-8">
        {["Fiber", "Butyrate", "Bifidobacterium", "Synbiotic"].map((tag) => (<span key={tag} className="text-xs bg-gray-100 text-gray-500 px-2.5 py-1 rounded-full">{tag}</span>))}
      </div>
