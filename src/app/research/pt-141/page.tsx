  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">PT-141 Research</h1>
        <span className="tag">Sexual Health</span>
      </div>
      <p className="text-sm text-gray-500 mb-8 leading-relaxed max-w-xl">Key peer-reviewed studies on PT-141 (Bremelanotide), a cyclic heptapeptide melanocortin receptor agonist. PT-141 is FDA-approved as Vyleesi for hypoactive sexual desire disorder (HSDD) in premenopausal women \u2014 making it one of the few research peptides with full FDA approval. It is also used off-label for male sexual dysfunction. Each summary is written in plain English. Click any title to read the full article.</p>
      ...
      <div className="mt-10 p-5 bg-gray-50 border border-gray-100 rounded-xl">
        <p className="text-sm font-medium text-gray-700 mb-1">View the full PT-141 profile</p>
        <p className="text-xs text-gray-500 mb-3">Mechanism of action, FDA approval, pharmacokinetics, and relationship to Melanotan II.</p>
