  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="mt-10 p-5 bg-gray-50 border border-gray-100 rounded-xl">
        <p className="text-sm font-medium text-gray-700 mb-1">View the full CJC-1295 profile</p>
        <p className="text-xs text-gray-500 mb-3">Mechanism of action, DAC vs non-DAC, pharmacokinetics, and Ipamorelin synergy.</p>
