...
export default function TesamorelinResearchPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Tesamorelin Research","description":"4 key Tesamorelin studies summarized in plain English. Covers FDA-approved visceral fat reduction, cognitive neurochemistry, and liver fat research.","url":"https://profpeptide.com/research/tesamorelin","publisher":{"@type":"Organization","name":"Prof. Peptide","url":"https://profpeptide.com"}}} />
      <JsonLd data={{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://profpeptide.com"},{"@type":"ListItem","position":2,"name":"Research","item":"https://profpeptide.com/research"},{"@type":"ListItem","position":3,"name":"Tesamorelin Research"}]}} />
