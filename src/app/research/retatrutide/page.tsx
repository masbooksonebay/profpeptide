  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Retatrutide Research</h1>
      ...
      <div className="mt-10 p-5 bg-gray-50 border border-gray-100 rounded-xl">
        <p className="text-sm font-medium text-gray-700 mb-1">View the full Retatrutide profile</p>
        <p className="text-xs text-gray-500 mb-3">Mechanism of action, TRIUMPH trial data, pharmacokinetics, and side effects.</p>
