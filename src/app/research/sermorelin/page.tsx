  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Sermorelin Research</h1>
        <span className="tag">Growth Hormone</span>
      </div>
      <p className="text-sm text-gray-500 mb-8 leading-relaxed max-w-xl">Key peer-reviewed studies on Sermorelin, a synthetic analog of the first 29 amino acids of GHRH. Sermorelin was formerly FDA-approved as a diagnostic tool for GH deficiency but was discontinued by the manufacturer in 2008 due to manufacturing difficulties \u2014 not safety concerns. It remains available as a compounded peptide. Each summary is written in plain English. Click any title to read the full article.</p>
      ...
      <div className="mt-10 p-5 bg-gray-50 border border-gray-100 rounded-xl">
        <p className="text-sm font-medium text-gray-700 mb-1">View the full Sermorelin profile</p>
        <p className="text-xs text-gray-500 mb-3">Mechanism of action, FDA history, pituitary preservation, and off-label use.</p>
