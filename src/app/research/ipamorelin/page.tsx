  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Ipamorelin Research</h1>
        <span className="tag">Growth Hormone</span>
      </div>
      <p className="text-sm text-gray-500 mb-8 leading-relaxed max-w-xl">Key peer-reviewed studies on Ipamorelin, a selective growth hormone secretagogue and ghrelin receptor agonist. Ipamorelin is not FDA approved and is banned by WADA. Research is primarily animal studies with limited human data. Each summary is written in plain English. Click any title to read the full article.</p>
      ...
      <div className="mt-10 p-5 bg-gray-50 border border-gray-100 rounded-xl">
        <p className="text-sm font-medium text-gray-700 mb-1">View the full Ipamorelin profile</p>
        <p className="text-xs text-gray-500 mb-3">Mechanism of action, selectivity data, pharmacokinetics, and CJC-1295 synergy.</p>
