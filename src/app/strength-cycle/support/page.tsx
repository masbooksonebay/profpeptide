...
export default function StrengthCycleSupportPage() {
  return (
    <div className="section max-w-3xl">
      <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100 mb-8">Strength Cycle — Support</h1>
      ...
      <div className="text-gray-600 dark:text-slate-300 space-y-6 text-sm leading-relaxed">
        <section>
          ...
          <p className="mt-2"><strong className="text-gray-800 dark:text-slate-200">Email:</strong> <a href="mailto:strengthcyclestudios@gmail.com" className="text-[#3A759F] hover:underline">strengthcyclestudios@gmail.com</a></p>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-semibold text-[#16181B] dark:text-slate-100 mb-1">Does Strength Cycle work on Apple Watch?</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#16181B] dark:text-slate-100 mb-1">How do I reset my training maxes?</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#16181B] dark:text-slate-100 mb-1">How does the e1RM calculation work?</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#16181B] dark:text-slate-100 mb-1">What 5/3/1 templates are supported?</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#16181B] dark:text-slate-100 mb-1">Is Strength Cycle affiliated with Jim Wendler?</h3>
        ...
        <section>
          ...
          <p>We welcome feature suggestions. Email us at <a href="mailto:strengthcyclestudios@gmail.com" className="text-[#3A759F] hover:underline">strengthcyclestudios@gmail.com</a> &mdash; we read everything, even if we can&apos;t always respond immediately.</p>
        </section>
