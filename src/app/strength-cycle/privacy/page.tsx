...
export default function StrengthCyclePrivacyPage() {
  return (
    <div className="section max-w-3xl">
      <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100 mb-3">Strength Cycle — Privacy Policy</h1>
      ...
      <div className="text-gray-600 dark:text-slate-300 space-y-6 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-2">Data We Collect</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-2">Data We Do Not Collect</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-2">Ask Coach Feature</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-2">Data Storage</h2>
