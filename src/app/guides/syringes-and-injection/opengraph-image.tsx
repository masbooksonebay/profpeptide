...
// Node runtime (not edge): the OFFICIAL brand mark (public/logo-glasses.png) is read from disk
// at render time, replacing the old hand-drawn glasses SVG. Edge can't readFile, so this route
// was converted off edge; the mark is traced for /guides/** via outputFileTracingIncludes.
export const alt = "Insulin Syringes & Injection — Prof. Peptide Guide";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          A practical guide for peptide research — units vs mcg, barrel sizing, and subcutaneous technique.
        </div>
