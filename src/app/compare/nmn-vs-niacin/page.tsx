...
export default function NMNvsNiacinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"NMN vs Niacin — NAD+ Precursor Comparison","description":"NMN vs Niacin comparison — how they raise NAD+, what the research shows, cost differences, side effects, and which is better for longevity.","url":"https://profpeptide.com/compare/nmn-vs-niacin","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
