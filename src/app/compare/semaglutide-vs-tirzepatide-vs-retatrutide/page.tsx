...
export default function TripleGLP1ComparisonPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Semaglutide vs Tirzepatide vs Retatrutide — GLP-1 Comparison","description":"Semaglutide vs Tirzepatide vs Retatrutide — mechanism, weight loss data, FDA status, and how all three GLP-1 peptides compare side by side.","url":"https://profpeptide.com/compare/semaglutide-vs-tirzepatide-vs-retatrutide","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Comparisons", path: "/compare" }, { name: "Semaglutide vs Tirzepatide vs Retatrutide — GLP-1 Comparison" }])} />
    ...
    <ContactLink pageName="Semaglutide vs Tirzepatide vs Retatrutide — GLP-1 Comparison" pagePath="/compare/semaglutide-vs-tirzepatide-vs-retatrutide" />
    </div>
    </>
  );
}
