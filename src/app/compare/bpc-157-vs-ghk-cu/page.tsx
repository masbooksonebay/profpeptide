  ...
  return (
    <div className="section max-w-4xl">
      ...
      <div className="overflow-x-auto mb-8">
        <table className="w-full text-sm border-collapse">
          <thead><tr className="bg-gray-50">
            ...
            <th className="text-left px-4 py-3 font-semibold text-[#0D7377] text-xs uppercase tracking-wider border-b border-gray-100 w-[37.5%]">GHK-Cu</th>
          </tr></thead>
      ...
      <div className="border border-gray-100 rounded-xl p-5 mb-8">
        ...
        <p className="text-sm text-gray-600"><Link href="/peptides/bpc-157" className="text-[#0D7377] hover:underline">BPC-157</Link> is the broader systemic repair peptide &mdash; strongest for gut, tendons, and CNS. <Link href="/peptides/ghk-cu" className="text-[#0D7377] hover:underline">GHK-Cu</Link> is the skin and wound healing specialist &mdash; particularly valuable for topical applications and anti-aging. They don&apos;t overlap significantly and can be studied together for comprehensive tissue repair protocols.</p>
      </div>
