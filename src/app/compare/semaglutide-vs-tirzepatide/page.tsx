...
export default function SemaglutideVsTirzepatidePage() {
  return (
    ...
    <ContactLink pageName="Semaglutide vs Tirzepatide — GLP-1 Peptide Comparison" pagePath="/compare/semaglutide-vs-tirzepatide" />
    </div>
    </>
  );
}
