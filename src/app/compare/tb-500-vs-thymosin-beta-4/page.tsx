...
export default function TB500vsThymosinBeta4Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"TB-500 vs Thymosin Beta-4: Fragment vs Full Protein","description":"TB-500 is the synthetic active fragment of the 43-amino-acid Thymosin Beta-4 protein — how the fragment and the full protein differ in structure, sourcing, and research.","url":"https://profpeptide.com/compare/tb-500-vs-thymosin-beta-4","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
