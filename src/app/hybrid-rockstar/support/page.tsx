...
export default function HybridRockstarSupportPage() {
  return (
    <div className="section max-w-3xl">
      <h1 className="text-3xl font-bold text-[#1e2d3d] dark:text-slate-100 mb-8">Hybrid Rockstar — Support</h1>
      ...
      <div className="text-gray-600 dark:text-slate-300 space-y-6 text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-semibold text-[#1e2d3d] dark:text-slate-100 mb-1">Does Hybrid Rockstar work on Apple Watch?</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#1e2d3d] dark:text-slate-100 mb-1">How do I reset my training data?</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#1e2d3d] dark:text-slate-100 mb-1">What training programs are supported?</h3>
              <p>The App currently supports two 12-week cycle structures: FullRox (full Hyrox-style training volume) and HalfRox (reduced volume for athletes balancing other training). Additional templates may be added in future updates.</p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-[#1e2d3d] dark:text-slate-100 mb-1">Is Hybrid Rockstar affiliated with Hyrox?</h3>
