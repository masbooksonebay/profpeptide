          ...
          <table className="w-full text-base text-left border-collapse border border-[#D9DEE4] dark:border-slate-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-[#16181B]">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">15 mg dose</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
              <tr className="even:bg-gray-50 dark:even:bg-[#1e293b]/50">
...
const peptideNews = articlesForPeptide("tirzepatide");
...
const tocSections = [
  ...
  { id: "overview", title: "What is Tirzepatide?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function TirzepatidePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Tirzepatide","description":"Tirzepatide (Mounjaro/Zepbound) research profile: mechanism, SURMOUNT trial results, dosing protocol, side effects, FAQ, and FDA approval status.","url":"https://profpeptide.com/peptides/tirzepatide","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Tirzepatide" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Tirzepatide</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made peptide that activates two gut-hormone receptors at once &mdash; GIP and GLP-1 &mdash; the first dual incretin agonist, studied for weight loss and type 2 diabetes.</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~5 days (~120 hours)</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Titrated from 2.5 mg, increasing every 4 weeks (2.5&rarr;5&rarr;7.5&rarr;10&rarr;12.5&rarr;15 mg) to a 15 mg weekly maximum</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">FDA-approved as Mounjaro and Zepbound &mdash; research-grade sold for laboratory use only.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Tirzepatide?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Common research dose:</span> FDA-approved dosing starts at 2.5 mg once weekly by subcutaneous injection, then increases every 4 weeks (2.5 → 5 → 7.5 → 10 → 12.5 → 15 mg) up to a maximum of 15 mg weekly. Most users settle at maintenance doses between 10 mg and 15 mg. Research-grade dosing protocols mirror the approved schedule.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
