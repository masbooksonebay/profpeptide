    ...
    node: (
      <div className="space-y-4">
        <ol className="list-decimal list-inside space-y-1">
          ...
          <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed"><span className="font-semibold">Site rotation (SC).</span> Sites are conventionally rotated each injection (abdomen, thigh, upper arm).</li>
...
const tocSections = [
  ...
  { id: "overview", title: "What is Selank?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function SelankPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Selank","description":"Selank research profile: GABAergic anxiolysis without sedation, intranasal dosing protocol, Semax stack, Russian clinical history, side effects, FAQ.","url":"https://profpeptide.com/peptides/selank","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Selank" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Selank</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made peptide derived from tuftsin, the body&apos;s own immune-signaling molecule &mdash; a non-sedating anxiolytic and nootropic studied for anxiety, stress resilience, and cognition.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Intranasal drops or spray, or subcutaneous injection</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Short plasma half-life; biological effects build over days</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">250&ndash;300 mcg per nostril, two to three times daily, in 14-day courses</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not FDA-approved; a prescription anxiolytic in Russia &mdash; elsewhere research use only.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Selank?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            Selank is a synthetic heptapeptide (Thr-Lys-Pro-Arg-Pro-Gly-Pro), also known by its developmental code TP-7 and marketed as a Russian anxiolytic peptide, developed in the 1990s at the Institute of Molecular Genetics of the Russian Academy of Sciences. It combines tuftsin (an endogenous immunomodulatory tetrapeptide derived from immunoglobulin G) with the same Pro-Gly-Pro stabilizing tail used in{" "}
            <Link href="/peptides/semax" className="text-[#3A759F] hover:underline">Semax</Link>
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Common research dose:</span> Standard intranasal protocol: 200–500 mcg per nostril, 2–3 times daily, administered as 0.15% solution. Standard course: 14 days.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
