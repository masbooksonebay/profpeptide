  ...
  return (
    <div className="section max-w-3xl">
      ...
      <p className="text-sm text-gray-500 mb-8">
        <strong className="text-gray-700">Also Known As:</strong> Body Protection Compound-157, Bepecin, PL-14736, Gastric Pentadecapeptide
      </p>
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-3">Mechanism of Action</h2>
            ...
            {[
              ...
              <div key={item.title} className="border-l-2 border-gray-200 pl-4">
                <p className="text-sm font-medium text-[#1e2d3d] mb-1">
                  {item.title} <span className="text-xs text-gray-400 font-normal">{item.refs}</span>
                </p>
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-3">Key Research Areas</h2>
          <div className="space-y-4">
            {[
              {
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-3">Observed Benefits in Research</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-3">Common Research Stacking</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-3">References</h2>
          <ol className="space-y-3">
            {[
              ...
              <li key={ref.num} className="flex gap-3 text-sm text-gray-600">
                <span className="text-gray-400 font-medium flex-shrink-0">[{ref.num}]</span>
                <span>
                  {ref.citation}{" "}
                  <a
                    href={ref.url}
                    ...
                    className="text-[#0D7377] hover:underline break-all"
                  >
                    {ref.url}
                  </a>
                </span>
