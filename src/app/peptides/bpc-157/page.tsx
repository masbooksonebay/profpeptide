    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/34380875/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
...
const peptideNews = articlesForPeptide("bpc-157");
...
export default function BPC157Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"BPC-157","description":"BPC-157 research profile: tendon healing mechanism, dosing protocol, side effects, FDA Category 2 status, FAQ, and current regulatory status.","url":"https://profpeptide.com/peptides/bpc-157","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "BPC-157" }])} />
