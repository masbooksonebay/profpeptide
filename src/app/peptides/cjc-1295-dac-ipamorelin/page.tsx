...
const sections = [
  ...
  },
  {
    ...
    intro:
      "Neither CJC-1295 DAC nor Ipamorelin is FDA-approved. Both are sold by specialty peptide vendors for laboratory research use only, almost always as separate vials (due to their incompatible dosing schedules). When sourcing CJC-1295, confirm with the vendor explicitly that the product is the with-DAC form — many vendors carry both variants, labeling can be ambiguous, and our data does not establish which form a given vendor's blend uses. The vendors below have been vetted for transparent third-party testing and traceable batch documentation, and carry CJC-1295 and Ipamorelin.",
    node: (
      <div className="space-y-4">
...
const tocSections = [
  { id: "overview", title: "What is CJC-1295 DAC + Ipamorelin?" },
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">CJC-1295 DAC + Ipamorelin</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A combination of CJC-1295 with DAC (a long-acting GHRH analog, ~6&ndash;8 day half-life) and Ipamorelin (a selective ghrelin agonist, ~2 hour half-life), for sustained GH-axis stimulation with fewer injections.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Two subcutaneous injections &mdash; CJC-1295 DAC once weekly, Ipamorelin 1&ndash;3&times; daily</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">CJC-1295 DAC ~6&ndash;8 days &middot; Ipamorelin ~2 hours</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">CJC-1295 DAC 1&ndash;2 mg once weekly + Ipamorelin 200&ndash;300 mcg, one to three times daily</dd>
            </div>
            <div>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is CJC-1295 DAC + Ipamorelin?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
