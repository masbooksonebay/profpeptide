...
export default function FollistatinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Follistatin","description":"Follistatin (FS-344) research profile: myostatin inhibition mechanism, dosing protocol, gene therapy data, side effects, FAQ, and current regulatory status.","url":"https://profpeptide.com/peptides/follistatin","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
