...
export default function SemaglutidePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Semaglutide","description":"Semaglutide (Ozempic/Wegovy/Rybelsus) research profile: mechanism, STEP trial results, SELECT cardiovascular data, dosing protocol, side effects, and FAQ.","url":"https://profpeptide.com/peptides/semaglutide","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
