  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="mt-10 p-5 border border-[#d0eeef] bg-[#f0fafa] rounded-xl">
        <h2 className="text-sm font-semibold text-[#1e2d3d] mb-2">How Does Semaglutide Compare?</h2>
        <p className="text-sm text-gray-600 mb-3">See how Semaglutide compares to Tirzepatide and Retatrutide in our side-by-side GLP-1 comparison.</p>
