...
const tocSections = [
  { id: "overview", title: "What is KLOW?" },
...
export default function KLOWPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"KLOW Blend","description":"KLOW peptide blend research profile: 4-component stack of BPC-157, TB-500, GHK-Cu, and KPV for tissue repair, skin remodeling, and inflammation control.","url":"https://profpeptide.com/peptides/klow","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "KLOW" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">KLOW</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A fixed-dose combination of BPC-157, TB-500, GHK-Cu, and KPV in a single injection &mdash; studied for tissue repair, skin remodeling, and anti-inflammatory/gut effects.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection, once daily (commonly at bedtime)</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">0.1 mL (10 units) once daily from an 80 mg vial &mdash; ~2.5 mg GHK-Cu + 0.5 mg each BPC-157/TB-500/KPV &mdash; in 8&ndash;12 week cycles</dd>
            </div>
            <div>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is KLOW?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
