...
const sections = [
  ...
  {
    id: "research",
    title: "What is KLOW used for in research?",
    tocTitle: "Research",
    intro:
  ...
  {
    id: "dosing",
    title: "How much KLOW do researchers use?",
    tocTitle: "Dosing",
    node: (
...
const tocSections = sections.map((s) => ({ id: s.id, title: s.tocTitle || s.title }));
