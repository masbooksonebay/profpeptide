    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://en.wikipedia.org/wiki/Ipamorelin" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/10373343/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/11735244/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/10828840/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
...
export default function IpamorelinPage() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Ipamorelin" }])} />
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Ipamorelin</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made peptide that signals the pituitary to release the body&apos;s own growth hormone &mdash; the most selective of the growth-hormone-releasing peptides, studied for recovery, lean mass, and sleep.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection, most often at bedtime</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~2 hours</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">200&ndash;300 mcg, one to three times daily, in 8&ndash;12 week cycles</dd>
            </div>
            <div>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Ipamorelin?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            Ipamorelin is a synthetic pentapeptide (Aib-His-D-2-Nal-D-Phe-Lys-NH2) developed by Novo Nordisk in the late 1990s as a selective agonist of the ghrelin/growth hormone secretagogue receptor (GHSR-1a). It is also known by its developmental code NNC 26-0161. Unlike other GHRPs (GHRP-2, GHRP-6), ipamorelin stimulates growth hormone release without elevating cortisol, prolactin, ACTH, FSH, LH, or TSH &mdash; making it the most selective GHRP available. It was investigated in Phase 2 trials for postoperative ileus but discontinued for lack of efficacy in that specific indication. Often paired with{" "}
            <Link href="/peptides/cjc-1295" className="text-[#3A759F] hover:underline">CJC-1295</Link>{" "}
            as the{" "}
            <Link href="/peptides/gh-stack" className="text-[#3A759F] hover:underline">GH Stack</Link>{" "}
