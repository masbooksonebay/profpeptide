...
const sections = [
  ...
  },
  {
    ...
    node: (
      <div className="space-y-4">
        <VendorHighlightBlock compoundSlug="retatrutide"
          highlights={[
...
const peptideNews = articlesForPeptide("retatrutide");
...
const tocSections = [
  ...
  { id: "overview", title: "What is Retatrutide?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function RetatrutidePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Retatrutide","description":"Retatrutide (LY3437943) research profile: mechanism, Phase 3 TRIUMPH trial results, dosing protocol, side effects, FAQ, and current regulatory status.","url":"https://profpeptide.com/peptides/retatrutide","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Retatrutide" }])} />
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Retatrutide</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made peptide that activates three metabolic hormone receptors at once &mdash; GLP-1, GIP, and glucagon &mdash; studied for weight loss and obesity.</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~6 days</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Starts at 2 mg once weekly, escalating every 4 weeks toward a 12 mg maintenance dose</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not FDA-approved &mdash; investigational (Phase 3); research use only.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div className="mb-8 p-4 border border-[#3A759F]/20 bg-[#3A759F]/10 rounded-xl">
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <NavLink href="/news/retatrutide-triumph-1-phase-3-results" className="text-[#3A759F] hover:underline">Read the full breakdown</NavLink>
        </p>
      </div>

      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Retatrutide?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
