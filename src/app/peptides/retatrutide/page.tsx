...
export default function RetatrutidePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Retatrutide","description":"Retatrutide (LY3437943) research profile: mechanism, Phase 3 TRIUMPH trial results, dosing protocol, side effects, FAQ, and current regulatory status.","url":"https://profpeptide.com/peptides/retatrutide","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
