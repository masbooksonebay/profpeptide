...
const tocSections = [
  ...
  { id: "overview", title: "What is PDA (Pentadeca Arginate)?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function PDAPage() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "PDA (Pentadeca Arginate)" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">PDA (Pentadeca Arginate)</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">Pentadeca Arginate &mdash; a synthetic 15-amino-acid, arginate-stabilized peptide that is the salt-form variant of BPC-157 (same sequence), studied for tissue repair and recovery.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection, once or twice daily</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">250&ndash;500 mcg subcutaneously, once or twice daily, in 4&ndash;8 week cycles (extrapolated from BPC-157)</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not FDA-approved &mdash; research use only. Inherits BPC-157&apos;s FDA Category 2 status (Nov 2023).</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is PDA (Pentadeca Arginate)?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
