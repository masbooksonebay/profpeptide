...
const tocSections = [
  { id: "overview", title: "What is the Wolverine Stack?" },
...
export default function WolverineStackPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Wolverine Stack","description":"Wolverine Stack research profile: 2-component BPC-157 + TB-500 blend for tendon, ligament, and soft-tissue repair. Mechanism, dosing, side effects, FAQ.","url":"https://profpeptide.com/peptides/wolverine-stack","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Wolverine Stack" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Wolverine Stack</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A fixed-dose combination of BPC-157 and TB-500, studied for musculoskeletal recovery and soft-tissue repair.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection &mdash; BPC-157 daily, TB-500 on a load-then-maintain schedule (pre-blended vials combine both in one shot)</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">BPC-157 under 30 minutes in plasma; TB-500 substantially longer (dosed only 1&ndash;2&times; weekly)</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">BPC-157 250&ndash;500 mcg daily + TB-500 2.0&ndash;2.5 mg twice weekly (load, weeks 1&ndash;4) then 2.0 mg once weekly (maintenance, weeks 5&ndash;8)</dd>
            </div>
            <div>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is the Wolverine Stack?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
