...
const tocSections = [
  { id: "overview", title: "What is LL-37?" },
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">LL-37</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">The sole human cathelicidin-derived antimicrobial and host-defense peptide, studied for antimicrobial, wound-healing, and immune-modulating effects &mdash; with a genuinely double-edged inflammatory biology.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">No validated human route or protocol &mdash; sold research-use-only</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">No validated human dose</dd>
            </div>
            <div>
