...
export default function CibinetidePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Cibinetide (ARA-290)","description":"Cibinetide (ARA-290) research profile: innate repair receptor mechanism, human Phase 2 trial data, dosing used in studies, evidence status, and limitations.","url":"https://profpeptide.com/peptides/cibinetide","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Cibinetide" }])} />
