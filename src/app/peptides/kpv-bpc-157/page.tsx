...
const tocSections = [
  { id: "overview", title: "What is the KPV + BPC-157 blend?" },
...
export default function KpvBpc157Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"KPV + BPC-157","description":"KPV + BPC-157 research profile: 2-component gut-healing stack combining NF-κB-blocking KPV with cytoprotective BPC-157 for IBD, mucosal repair, and systemic inflammation. Mechanism, dosing (oral & SC), side effects, FAQ.","url":"https://profpeptide.com/peptides/kpv-bpc-157","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "KPV + BPC-157" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">KPV + BPC-157</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A fixed-dose research combination of KPV (an anti-inflammatory &alpha;-MSH tripeptide that blocks NF-&kappa;B signaling) and BPC-157 (a gut-protective recovery peptide), studied for gut/IBD, mucosal repair, and systemic inflammation.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Oral for gut-local action, or subcutaneous injection for systemic effects</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not well characterized in humans for either component</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">KPV 200&ndash;500 mcg/day + BPC-157 250&ndash;500 mcg/day, in 6&ndash;8 week cycles</dd>
            </div>
            <div>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is the KPV + BPC-157 blend?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
