  ...
  },
  {
    ...
    a: (
      <>
        ...
        <Link href="/compare/cjc-1295-vs-sermorelin-vs-ipamorelin" className="text-[#3A759F] hover:underline">CJC-1295 vs Sermorelin vs Ipamorelin comparison</Link>{" "}
  ...
  },
  {
    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          Wikipedia. CJC-1295.{" "}
          <a href="https://en.wikipedia.org/wiki/CJC-1295" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/19386527/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://journals.physiology.org/doi/full/10.1152/ajpendo.00201.2006" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
...
const peptideNews = articlesForPeptide("cjc-1295");
...
export default function CJC1295Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"CJC-1295","description":"CJC-1295 (with DAC and without DAC) research profile: GHRH receptor mechanism, dosing protocol, ipamorelin stack, side effects, FAQ, and regulatory status.","url":"https://profpeptide.com/peptides/cjc-1295","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "CJC-1295" }])} />
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">CJC-1295</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made peptide that prompts the body to release its own growth hormone, made in a long-acting (DAC) and a short-acting (no-DAC) form, studied for recovery and body composition.</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~30 minutes (no-DAC) to 6&ndash;8 days (with DAC)</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">With DAC, 1&ndash;2 mg once or twice weekly; without DAC, ~100 mcg per dose several times daily; 8&ndash;12 week cycles</dd>
            </div>
            <div>
