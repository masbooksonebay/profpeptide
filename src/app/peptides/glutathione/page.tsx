    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/18796312/" target="_blank" rel="noopener noreferrer" className="text-[#0891b2] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/21795440/" target="_blank" rel="noopener noreferrer" className="text-[#0891b2] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/24791752/" target="_blank" rel="noopener noreferrer" className="text-[#0891b2] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/21875351/" target="_blank" rel="noopener noreferrer" className="text-[#0891b2] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/27088927/" target="_blank" rel="noopener noreferrer" className="text-[#0891b2] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/28436395/" target="_blank" rel="noopener noreferrer" className="text-[#0891b2] hover:underline break-words">
  ...
  return (
    ...
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl font-bold text-[#1e2d3d] dark:text-slate-100">Glutathione (GSH)</h1>
      ...
      <div className="mb-8 p-4 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
          <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Also Known As:</span> GSH, L-Glutathione, reduced glutathione, γ-glutamylcysteinylglycine
        </p>
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed pt-1">
          <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Peptide Class:</span> Endogenous tripeptide (glutamate-cysteine-glycine) &mdash; primary intracellular antioxidant / thiol
        </p>
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed pt-1">
          <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Regulatory Status:</span> Not FDA-approved as a treatment; sold as a dietary supplement (benefits not well defined by regulators) and research-use-only. Skin-whitening use is not FDA-evaluated.
        </p>
      </div>

      <div id="overview" className="scroll-mt-20">
        <h2 className="text-lg font-semibold text-[#1e2d3d] dark:text-slate-100 mb-2">What is glutathione?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">A note on the longevity context:</span> glutathione sits alongside compounds like{" "}
            <Link href="/peptides/nad-plus" className="text-[#0891b2] hover:underline">NAD+</Link>{" "}
            and{" "}
            <Link href="/peptides/ss-31" className="text-[#0891b2] hover:underline">SS-31</Link>{" "}
      ...
      <div className="mt-6 p-5 bg-gray-50 dark:bg-[#1e293b] border border-gray-100 dark:border-slate-700 rounded-xl">
        ...
        <Link href="/peptides/ss-31" className="text-sm font-medium text-[#0891b2] hover:underline">SS-31</Link>
