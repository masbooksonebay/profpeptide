...
export default function GlutathionePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Glutathione (GSH)","description":"Glutathione (GSH) research profile: the body's master intracellular antioxidant — mechanism, the oral bioavailability problem, precursor (NAC) science, unproven skin-whitening claims, dosing, safety, and regulatory status.","url":"https://profpeptide.com/peptides/glutathione","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Glutathione (GSH)" }])} />
