  ...
  },
  {
    ...
    a: (
      <>
        ...
        <Link href="/peptides/tesamorelin" className="text-[#3A759F] hover:underline">Tesamorelin profile</Link>{" "}
        and{" "}
        <Link href="/peptides/ipamorelin" className="text-[#3A759F] hover:underline">Ipamorelin profile</Link>{" "}
          ...
          <table className="w-full text-base text-left border-collapse border border-[#D9DEE4] dark:border-slate-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-[#16181B]">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">Vial</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">BAC Water</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">Conc.</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">1 mg / 200 mcg dose</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">2 mg / 300 mcg dose</th>
              </tr>
            </thead>
    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/18057338/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/18690162/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
...
const tocSections = [
  { id: "overview", title: "What is Tesamorelin + Ipamorelin?" },
...
export default function TesaIpamorelinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Tesamorelin + Ipamorelin","description":"Tesamorelin + Ipamorelin research profile: FDA-referenced GHRH analog + selective GHRP dual-pathway blend, visceral-fat reduction angle, IGF-1 elevation, dosing protocol, side effects, FAQ.","url":"https://profpeptide.com/peptides/tesamorelin-ipamorelin","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Tesamorelin + Ipamorelin" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Tesamorelin + Ipamorelin</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A combination of Tesamorelin (a stabilized GHRH analog, FDA-approved on its own as Egrifta) and Ipamorelin (a selective ghrelin / GHS-R1a agonist) that stimulates growth hormone through two pituitary pathways &mdash; studied for visceral-fat reduction and body composition.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Both by subcutaneous injection, once daily &mdash; commonly pre-bed on an empty stomach</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Tesamorelin ~26 min; Ipamorelin ~2 hours</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Tesamorelin 1&ndash;2 mg + Ipamorelin 200&ndash;300 mcg SC once daily, in 8&ndash;16 week cycles</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Tesamorelin is FDA-approved on its own as Egrifta; Ipamorelin is not approved, and the combination is not an approved product &mdash; research use only. Both WADA S2 prohibited.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Tesamorelin + Ipamorelin?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Common research dose:</span> Tesamorelin 1&ndash;2 mg SC once daily + Ipamorelin 200&ndash;300 mcg SC daily (commonly pre-bed, empty stomach). Titrate Tesamorelin from 1 mg; monitor IGF-1 at baseline and every 4&ndash;8 weeks.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Where to buy:</span> Typically sold as separate lyophilized vials by research peptide vendors. Neither research-grade Tesamorelin nor Ipamorelin is FDA-approved at research-grade doses. See{" "}
            <Link href="/coupons" className="text-[#3A759F] hover:underline">
