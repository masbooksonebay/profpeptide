...
const faqs = [
  ...
  },
  {
    ...
    a: (
      <>
        Cortagen is sold by specialty research peptide vendors for laboratory use only. Quality varies &mdash; verify a Certificate of Analysis before purchase. Among the vetted vendors, Peptides.gg carries the Khavinson bioregulator line &mdash; see the{" "}
    ...
    <div className="section max-w-3xl">
      ...
      <div id="overview" className="scroll-mt-20">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#1e2d3d] dark:text-slate-100">Where to buy:</span> Cortagen is sold by specialty peptide vendors for laboratory use only. Among the vetted vendors, Peptides.gg carries the Khavinson bioregulator line. See the{" "}
            <Link href="/coupons/peptides-gg" className="text-[#0891b2] hover:underline">
              Peptides.gg discount code (PROF15) &rarr;
            </Link>{" "}
            for current options.
