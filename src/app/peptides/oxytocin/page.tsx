...
export default function OxytocinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Oxytocin","description":"Oxytocin research profile: nonapeptide neuropeptide/hormone — FDA-approved obstetric use (Pitocin/Syntocinon), the oversold 'trust hormone' behavioral narrative, libido research, mechanism, dosing, stability, safety, and regulatory status.","url":"https://profpeptide.com/peptides/oxytocin","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
