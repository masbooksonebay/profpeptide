...
const tocSections = [
  { id: "overview", title: "What is Oxytocin?" },
...
export default function OxytocinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Oxytocin","description":"Oxytocin research profile: nonapeptide neuropeptide/hormone — FDA-approved obstetric use (Pitocin/Syntocinon), the oversold 'trust hormone' behavioral narrative, libido research, mechanism, dosing, stability, safety, and regulatory status.","url":"https://profpeptide.com/peptides/oxytocin","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Oxytocin" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Oxytocin</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A nine-amino-acid neuropeptide (OT) with two lives &mdash; an FDA-approved obstetric medicine (Pitocin/Syntocinon) for labor and lactation, and the oversold &ldquo;love/trust hormone&rdquo; of behavioral research.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Intravenous in approved obstetric use; intranasal in behavioral research</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Short-acting; reconstituted oxytocin is comparatively unstable &mdash; refrigerate and use within a shorter window than a typical peptide</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Behavioral research commonly uses ~24 IU intranasally; no validated dose for social, bonding, or libido use</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">FDA-approved for obstetric use (Pitocin/Syntocinon); behavioral, bonding, and libido uses are investigational, research-use-only.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Oxytocin?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            Oxytocin (abbreviated OT) is a nine-amino-acid neuropeptide and hormone made in the hypothalamus and released from the posterior pituitary. It has two very different lives. In one, it is a well-understood hormone of labor and lactation and a genuine, FDA-approved obstetric medicine (marketed as Pitocin and Syntocinon). In the other, it is the famous &ldquo;love hormone,&rdquo; &ldquo;cuddle hormone,&rdquo; or &ldquo;trust hormone&rdquo; of popular science &mdash; a reputation built on behavioral studies that turned out to be far messier and less reliable than the headlines implied. A serious profile has to hold both of these at once.
          </p>
