...
export default function GLOWPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"GLOW","description":"GLOW peptide stack research profile: GHK-Cu + BPC-157 + TB-500 synergy for skin, hair, and tissue repair. Mechanism, dosing, side effects.","url":"https://profpeptide.com/peptides/glow","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
