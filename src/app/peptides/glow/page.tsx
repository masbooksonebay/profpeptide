      ...
      <div className="space-y-3">
        ...
        <div className="pt-4">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed pt-2">
            ...
            <Link href="/peptides/klow" className="text-[#3A759F] hover:underline">KLOW</Link>, which adds 10 mg KPV to the GLOW backbone (80 mg total, 50/10/10/10 split). Stepping down to{" "}
            <Link href="/peptides/wolverine-stack" className="text-[#3A759F] hover:underline">Wolverine Stack</Link>{" "}
...
const tocSections = [
  { id: "overview", title: "What is GLOW?" },
...
export default function GLOWPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"GLOW","description":"GLOW peptide stack research profile: GHK-Cu + BPC-157 + TB-500 synergy for skin, hair, and tissue repair. Mechanism, dosing, side effects.","url":"https://profpeptide.com/peptides/glow","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "GLOW" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">GLOW</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A fixed-dose combination of BPC-157, TB-500, and GHK-Cu &mdash; a 5:1:1 blend studied for skin quality, connective-tissue repair, and recovery in a single injection.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection, 5 days on / 2 off, at bedtime (GHK-Cu is also used topically)</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not established for the blend &mdash; varies by component</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">0.25&ndash;0.5 mL of the reconstituted 70 mg blend, 5 days/week, in 8&ndash;12 week cycles</dd>
            </div>
            <div>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is GLOW?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Common research dose:</span> Standard protocol: 0.25–0.5 mL of reconstituted blend, 5 days/week (5-on, 2-off), at bedtime. Approximately 40 doses per 70 mg vial. See{" "}
