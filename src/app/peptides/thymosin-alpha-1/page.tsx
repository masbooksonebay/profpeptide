  ...
  },
  {
    ...
    a: (
      <>
        ...
        <Link href="/peptides/tb-500" className="text-[#3A759F] hover:underline">Thymosin Beta-4 (TB-500)</Link>{" "}
          ...
          <table className="w-full text-base text-left border-collapse border border-[#D9DEE4] dark:border-slate-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-[#16181B]">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">1.6 mg (Zadaxin)</th>
    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/23327199/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
            https://pubmed.ncbi.nlm.nih.gov/23327199/
          </a>
        </li>
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          Wikipedia. Thymalfasin.{" "}
          <a href="https://en.wikipedia.org/wiki/Thymalfasin" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
...
const tocSections = [
  ...
  { id: "overview", title: "What is Thymosin Alpha-1?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function ThymosinAlpha1Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Thymosin Alpha-1","description":"Thymosin Alpha-1 (Zadaxin) research profile: T-cell maturation mechanism, hepatitis approval, dosing protocol, side effects, FAQ, and immune modulation.","url":"https://profpeptide.com/peptides/thymosin-alpha-1","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Thymosin Alpha-1" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Thymosin Alpha-1</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A 28-amino-acid immune-modulating peptide from the thymus &mdash; it promotes T-cell maturation and is studied for immune support, chronic viral infection, and as a vaccine adjuvant.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection, twice weekly to daily depending on protocol</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~2 hours plasma &mdash; immune effects on T-cell maturation persist far longer</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">1.6 mg twice weekly (Zadaxin standard), or 250&ndash;750 mcg daily for research immune support</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not FDA-approved in the US; approved as Zadaxin in 35+ countries &mdash; US research use only.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div id="overview" className="scroll-mt-24">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Common research dose:</span> Subcutaneous injection: 1.6 mg twice weekly (standard Zadaxin protocol for hepatitis), or 1.6 mg daily for 5 days followed by 2 days off (cancer adjunct protocol). Research peptide protocols often use 250–750 mcg daily. Cycle length: 4–12 weeks.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
