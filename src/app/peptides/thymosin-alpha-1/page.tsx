...
export default function ThymosinAlpha1Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Thymosin Alpha-1","description":"Thymosin Alpha-1 (Zadaxin) research profile: T-cell maturation mechanism, hepatitis approval, dosing protocol, side effects, FAQ, and immune modulation.","url":"https://profpeptide.com/peptides/thymosin-alpha-1","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
