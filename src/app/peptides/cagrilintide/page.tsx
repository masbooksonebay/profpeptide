...
const sections = [
          ...
          <table className="w-full text-base text-left border-collapse border border-[#D9DEE4] dark:border-slate-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-[#16181B]">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">0.3 mg dose</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">0.6 mg dose</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">1.2 mg dose</th>
  ...
  },
  {
    ...
    node: (
      <div className="space-y-4">
        <VendorHighlightBlock compoundSlug="cagrilintide"
          highlights={[
    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/34798060/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/33894838/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://www.nejm.org/doi/full/10.1056/NEJMoa2502486" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://www.the-innovation.org/article/doi/10.59717/j.xinn-med.2025.100150" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
...
const peptideNews = articlesForPeptide("cagrilintide");
...
const tocSections = [
  ...
  { id: "overview", title: "What is Cagrilintide?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function CagrilintidePage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Cagrilintide","description":"Cagrilintide research profile: amylin/calcitonin receptor mechanism, REDEFINE trial results, CagriSema combination, dosing, side effects, FAQ.","url":"https://profpeptide.com/peptides/cagrilintide","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Cagrilintide" }])} />
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Cagrilintide</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made long-acting amylin analog that mimics the satiety hormone amylin to curb appetite and slow gastric emptying &mdash; studied for weight loss, most often paired with semaglutide as CagriSema.</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~178 hours (~7 days) &mdash; supports once-weekly dosing</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">0.16&ndash;2.4 mg once weekly, escalated every 4 weeks</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not FDA-approved &mdash; investigational (Phase 3; CagriSema NDA filed Dec 2025). Research use only.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Cagrilintide?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            Cagrilintide (developmental code AM833) is an investigational long-acting amylin analogue developed by Novo Nordisk for chronic weight management. It works by mimicking amylin, a hormone the pancreas releases alongside insulin after meals. Combined with{" "}
            <Link href="/peptides/semaglutide" className="text-[#3A759F] hover:underline">semaglutide</Link>{" "}
            as{" "}
            <Link href="/peptides/cagrisema" className="text-[#3A759F] hover:underline">CagriSema</Link>
