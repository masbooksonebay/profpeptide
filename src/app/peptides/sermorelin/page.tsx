...
export default function SermorelinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Sermorelin","description":"Sermorelin research profile: native GHRH(1-29) mechanism, dosing protocol, FDA history (Geref), ipamorelin stack, side effects, FAQ, and regulatory status.","url":"https://profpeptide.com/peptides/sermorelin","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
