    ...
    node: (
      <div className="space-y-3">
        <ul className="list-disc list-inside space-y-2">
          ...
          <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed"><span className="font-semibold">AOD-9604&apos;s pivotal human trial failed.</span> Despite strong preclinical fat-loss signals across roughly six clinical trials (~900 participants), the pivotal Phase IIb study did not show clinically meaningful weight loss versus placebo, and commercial development was terminated in 2007. AOD-9604 is not FDA-approved for obesity. (Australia&apos;s TGA has separately approved an AOD-9604 preparation for a non-obesity, intra-articular indication.)</li>
