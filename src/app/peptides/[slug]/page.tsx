  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-8">
        <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100">{data.name}</h1>
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-2">Mechanism of Action</h2>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">{data.mechanism}</p>
        </div>

        <div>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-2">Key Research Areas</h2>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">{data.research}</p>
        </div>

        <div>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-3">Half-Life &amp; Stability</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-2">Research Limitations &amp; Regulatory Status</h2>
