...
const peptideData: Record<string, PeptideData> = {
  "semaglutide": {
    name: "Semaglutide", category: "GLP-1 Receptor Agonist", halfLife: "~7 days", route: "Subcutaneous injection or oral",
  ...
  "bpc-157": {
    name: "BPC-157", category: "Tissue Repair Peptide", halfLife: "~4 hours (estimated)", route: "Subcutaneous, intramuscular, or oral",
  ...
  "tb-500": {
    name: "TB-500", category: "Tissue Repair Peptide", halfLife: "Unknown", route: "Subcutaneous injection",
  ...
  "ipamorelin": {
    name: "Ipamorelin", category: "Growth Hormone Releasing Peptide", halfLife: "~2 hours", route: "Subcutaneous injection",
  ...
  "cjc-1295": {
    name: "CJC-1295", category: "GHRH Analogue", halfLife: "~6-8 days (with DAC)", route: "Subcutaneous injection",
  ...
  "selank": {
    name: "Selank", category: "Peptide Nootropic", halfLife: "~2 minutes (intranasal)", route: "Intranasal or subcutaneous",
  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap gap-4 text-sm text-gray-500 mb-8">
        <span><strong className="text-gray-700">Half-life:</strong> {data.halfLife}</span>
        <span><strong className="text-gray-700">Route:</strong> {data.route}</span>
      </div>
      ...
      <div className="space-y-8">
        {[
          { heading: "Overview", body: data.overview },
          { heading: "Mechanism of Action", body: data.mechanism },
          { heading: "Research Summary", body: data.research },
          { heading: "Research Notes", body: data.notes },
        ].map((section) => (
          <div key={section.heading}>
            <h2 className="text-lg font-semibold text-[#1e2d3d] mb-2">{section.heading}</h2>
