...
export default function AdamaxPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Adamax","description":"Adamax research profile: a vendor-marketed N-acetyl-Semax adamantane analog with no peer-reviewed literature. What it is claimed to be, the real Semax family context, and an honest look at the evidence gap.","url":"https://profpeptide.com/peptides/adamax","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Adamax" }])} />
