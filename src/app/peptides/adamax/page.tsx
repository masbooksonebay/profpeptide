...
export default function AdamaxPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Adamax","description":"Adamax research profile: a vendor-marketed N-acetyl-Semax adamantane analog with no peer-reviewed literature. What it is claimed to be, the real Semax family context, and an honest look at the evidence gap.","url":"https://profpeptide.com/peptides/adamax","publisher": { "@id": "https://profpeptide.com/#organization" }}} />
