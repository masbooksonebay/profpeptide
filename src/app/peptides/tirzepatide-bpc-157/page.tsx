...
const tocSections = [
  { id: "overview", title: "What is Tirzepatide + BPC-157?" },
...
export default function TirzepatideBpc157Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Tirzepatide + BPC-157","description":"Tirzepatide + BPC-157 research blend profile: dual GIP/GLP-1 agonist paired with BPC-157 for GI-side-effect mitigation and lean-mass protection. Mechanism, dosing, side effects, FAQ.","url":"https://profpeptide.com/peptides/tirzepatide-bpc-157","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Tirzepatide + BPC-157" }])} />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-2">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Tirzepatide + BPC-157</h1>
          ...
          <div className="px-5 py-4">
            ...
            <dl className="space-y-3">
              <div>
                ...
                <dd className="text-base text-[#16181B] dark:text-slate-100">A combination of tirzepatide (a GIP/GLP-1 dual agonist for weight loss) and BPC-157 (a gut-protective recovery peptide), paired to offset the GI side effects and lean-mass loss that accompany weight-loss research.</dd>
              </div>
              <div>
                <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
                <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection from separate vials &mdash; tirzepatide once weekly, BPC-157 once daily</dd>
              </div>
              <div>
                <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
                <dd className="text-sm text-[#16181B] dark:text-slate-200">Tirzepatide ~5 days; BPC-157 minutes to hours</dd>
              </div>
              <div>
                ...
                <dd className="text-sm text-[#16181B] dark:text-slate-200">Tirzepatide 2.5&ndash;15 mg once weekly (titrated) + BPC-157 250&ndash;500 mcg once daily &mdash; never pre-blended</dd>
              </div>
              <div>
                <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
                <dd className="text-sm text-[#16181B] dark:text-slate-200">Not an FDA-approved product &mdash; research use only. Tirzepatide is FDA-approved separately (Mounjaro/Zepbound); BPC-157 is not, and the combination itself is not an approved product.</dd>
              </div>
            </dl>
          </div>
        </section>
        ...
        <div id="overview" className="scroll-mt-24">
          <h2 className="section-heading mb-3">What is Tirzepatide + BPC-157?</h2>
          <div className="space-y-4">
            <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
