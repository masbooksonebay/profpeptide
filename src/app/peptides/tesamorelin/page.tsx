    ...
    node: (
      <div className="space-y-4">
        <ol className="list-decimal list-inside space-y-1">
          ...
          <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed"><span className="font-semibold">Missed dose.</span> Skip and resume next day. The convention is not to double-dose.</li>
          ...
          <table className="w-full text-base text-left border-collapse border border-[#D9DEE4] dark:border-slate-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-[#16181B]">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">1.28 mg (WR)</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">1.4 mg (SV)</th>
...
const tocSections = [
  ...
  { id: "overview", title: "What is Tesamorelin?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function TesamorelinPage() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"Tesamorelin","description":"Tesamorelin (Egrifta WR / Egrifta SV) research profile: FDA-approved for HIV lipodystrophy, GHRH receptor mechanism, Phase 3 visceral fat data, dosing, FAQ.","url":"https://profpeptide.com/peptides/tesamorelin","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "Tesamorelin" }])} />
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">Tesamorelin</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made copy of growth-hormone-releasing hormone (GHRH) that signals the pituitary to release the body&apos;s own growth hormone &mdash; the only GHRH analog with FDA approval, studied for reducing deep visceral belly fat.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection in the abdomen, once daily</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~26&ndash;38 minutes</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">1&ndash;2 mg once daily (FDA formulations: 1.28&ndash;1.4 mg/day)</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">FDA-approved (Egrifta) for HIV-associated lipodystrophy &mdash; all other uses off-label.</dd>
            </div>
          </dl>
        </div>
      </section>
      ...
      <div className="mb-8 p-4 border border-[#3A759F]/20 bg-[#3A759F]/10 rounded-xl">
        <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
          <span className="font-semibold text-[#16181B] dark:text-slate-100">Latest research:</span> Egrifta WR (F8 formulation, 1.28 mg/day, weekly reconstitution) received FDA approval March 25, 2025 &mdash; replacing the older Egrifta SV for many patients. The new formulation reduces injection-site adverse events and improves stability of reconstituted solution.
        </p>
      </div>

      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is Tesamorelin?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            Tesamorelin (brand names Egrifta, Egrifta SV, Egrifta WR) is a synthetic 44-amino-acid analog of human growth hormone-releasing hormone (GHRH) developed by Theratechnologies under the code TH9507. It is the only GHRH analog with current FDA approval &mdash; approved in November 2010 for reduction of excess abdominal fat (visceral adipose tissue) in HIV-infected adults with lipodystrophy. Unlike{" "}
            <Link href="/peptides/cjc-1295" className="text-[#3A759F] hover:underline">CJC-1295</Link>{" "}
            or{" "}
            <Link href="/peptides/sermorelin" className="text-[#3A759F] hover:underline">sermorelin</Link>
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Common research dose:</span> FDA-approved dose: Egrifta SV 1.4 mg subcutaneously once daily, OR Egrifta WR 1.28 mg subcutaneously once daily (newer weekly-reconstitution formulation). The older Egrifta original dose was 2 mg/day. Research-grade tesamorelin is typically dosed at 1–2 mg/day subcutaneously.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Where to buy:</span> Tesamorelin is the only FDA-approved GHRH analog. PP maintains a vetted list of peptide vendors with verified discount codes for research-grade material. See{" "}
            <NavLink href="/coupons" className="text-[#3A759F] hover:underline">Verified Discount Codes</NavLink>{" "}
            for current options.
          </p>
        </div>
