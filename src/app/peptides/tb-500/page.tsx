...
const sections = [
    ...
    node: (
      <div className="space-y-3">
        ...
        <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <NavLink href="/faq/how-often-is-tb-500-dosed" className="text-[#3A759F] hover:underline">How often is TB-500 dosed?</NavLink>
        </p>
      </div>
    ),
  },
    ...
    node: (
      <div className="space-y-4">
        <ol className="list-decimal list-inside space-y-1">
          ...
          <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed"><span className="font-semibold">Missed dose.</span> The reported practice is to administer a missed loading-phase dose if less than 24 hours late, and otherwise to skip to the next scheduled day.</li>
          ...
          <table className="w-full text-base text-left border-collapse border border-[#D9DEE4] dark:border-slate-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-[#16181B]">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">2.5 mg dose</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
              <tr className="even:bg-gray-50 dark:even:bg-[#1e293b]/50">
  ...
  },
  {
    ...
    node: (
      <div className="space-y-5">
        ...
        <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          <span className="font-semibold">Common question:</span>{" "}
          <NavLink href="/faq/thymosin-beta-4-side-effects" className="text-[#3A759F] hover:underline">What are the side effects of thymosin beta-4?</NavLink>
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    node: (
      <div className="space-y-4">
        <VendorHighlightBlock compoundSlug="tb-500"
          highlights={[
    ...
    node: (
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://www.nature.com/articles/nature03000" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/17108969/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://www.archivesofmedicalscience.com/Thymosin-4-improves-the-survival-of-cutaneous-flaps-of-rat-and-activates-Wnt-catenin-pathway/183145/0/article.html" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://pubmed.ncbi.nlm.nih.gov/20536468/" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
        ...
        <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0130040" target="_blank" rel="noopener noreferrer" className="text-[#3A759F] hover:underline break-words">
...
export default function TB500Page() {
  return (
    <>
      <JsonLd data={{"@context":"https://schema.org","@type":"Article","headline":"TB-500","description":"TB-500 (Thymosin Beta-4 fragment) research profile: actin/cellular migration mechanism, dosing protocol, wound healing research, side effects, FAQ, and regulatory status.","url":"https://profpeptide.com/peptides/tb-500","publisher": { "@type": "Organization", "@id": "https://profpeptide.com/#organization", "name": "Prof. Peptide", "url": "https://profpeptide.com", "logo": "https://profpeptide.com/icon.png" }}} />
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "TB-500" }])} />
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">TB-500</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A lab-made fragment of a natural repair protein (Thymosin Beta-4), studied for wound healing, muscle and tendon recovery, and cardiac and corneal repair.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous injection, once or twice weekly</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Multiple days (estimated from animal studies)</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">2.0&ndash;2.5 mg twice weekly to load, then ~2.0 mg weekly; 6&ndash;8 week cycles</dd>
            </div>
            <div>
      ...
      <div id="overview" className="scroll-mt-24">
        <h2 className="section-heading mb-3">What is TB-500?</h2>
        <div className="space-y-4">
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            TB-500 is a synthetic fragment of Thymosin Beta-4 (Tβ4), a naturally occurring 43-amino-acid peptide found in virtually all mammalian cells. TB-500 corresponds to the active Tβ4 17-23 region of Thymosin Beta-4 (gene symbol TMSB4X). Unlike the full Thymosin Beta-4 protein, TB-500 is a shorter active fragment that&apos;s easier to synthesize and study. Researchers have studied it for over two decades, primarily for wound healing, cardiac repair, and corneal regeneration. It&apos;s commonly paired with{" "}
            <Link href="/peptides/bpc-157" className="text-[#3A759F] hover:underline">BPC-157</Link>{" "}
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
            <span className="font-semibold text-[#16181B] dark:text-slate-100">Common research dose:</span> Most research protocols use 2.0–2.5 mg subcutaneously twice weekly for the first 4 weeks (loading phase), then 2.0 mg once weekly for maintenance. Total cycle length is typically 6–8 weeks, followed by 4–6 weeks off.
          </p>
          <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
