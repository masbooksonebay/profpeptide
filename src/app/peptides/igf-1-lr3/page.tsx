    ...
    node: (
      <div className="space-y-4">
        <ol className="list-decimal list-inside space-y-1">
          ...
          <li className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed"><span className="font-semibold">Missed dose.</span> Skip and resume the next day. The convention is not to double-dose &mdash; doubling significantly increases hypoglycemia risk.</li>
          ...
          <table className="w-full text-base text-left border-collapse border border-[#D9DEE4] dark:border-slate-700 rounded-lg overflow-hidden">
            <thead className="bg-gray-100 dark:bg-[#16181B]">
              <tr>
                ...
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">20 mcg dose</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">30 mcg dose</th>
                <th className="px-4 py-3 font-semibold text-[#16181B] dark:text-slate-100">40 mcg dose</th>
    ...
    node: (
      <div className="space-y-5">
        ...
        <p className="text-lg text-gray-600 dark:text-slate-300 leading-relaxed">
          ...
          <NavLink href="/faq/igf-1-lr3-side-effects" className="text-[#3A759F] hover:underline">What are the side effects of IGF-1 LR3?</NavLink>
        </p>
      </div>
    ),
  },
...
const tocSections = [
  ...
  { id: "overview", title: "What is IGF-1 LR3?" },
  ...sections.filter((s) => s.id !== "where-to-buy").map((s) => ({ id: s.id, title: s.title })),
];
...
export default function IGF1LR3Page() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Peptides", path: "/peptides" }, { name: "IGF-1 LR3" }])} />
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#16181B] dark:text-slate-100 tracking-tight">IGF-1 LR3</h1>
        ...
        <div className="px-5 py-4">
          ...
          <dl className="space-y-3">
            <div>
              ...
              <dd className="text-base text-[#16181B] dark:text-slate-100">A long-acting engineered analog of insulin-like growth factor-1 (IGF-1) &mdash; structurally modified to resist deactivation and stay active far longer than the natural hormone, studied for muscle growth, hypertrophy, and recovery.</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">How it&apos;s taken</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Subcutaneous (or intramuscular) injection, once daily &mdash; always with food</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Half-life</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">~20&ndash;30 hours</dd>
            </div>
            <div>
              ...
              <dd className="text-sm text-[#16181B] dark:text-slate-200">20&ndash;50 mcg per day, in 4&ndash;6 week cycles</dd>
            </div>
            <div>
              <dt className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400 mb-0.5">Research status</dt>
              <dd className="text-sm text-[#16181B] dark:text-slate-200">Not FDA-approved &mdash; research use only. WADA-prohibited (Section S2).</dd>
            </div>
          </dl>
        </div>
      </section>
