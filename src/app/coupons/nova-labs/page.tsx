      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="How does NOVA Labs test its peptides?" a="Every NOVA Labs peptide is third-party HPLC and mass-spec tested to ≥99% purity, and every batch is independently tested before release by accredited third-party laboratories — never self-reported. Each peptide carries a unique identifier tied to its Certificate of Analysis." />
