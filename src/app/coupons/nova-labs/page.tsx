    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            NOVA Labs states that every peptide is third-party HPLC and mass-spec tested to &ge;99% purity, and that every batch is independently tested before release by accredited third-party laboratories &mdash; never self-reported. Each peptide carries a unique identifier tied to its Certificate of Analysis, and NOVA publishes a Batch Testing Results table that links the per-batch COA and third-party lab verification (for example, Janoshik) so researchers can confirm a specific lot before purchase.
          </p>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="How does NOVA Labs test its peptides?" a="NOVA Labs states that every peptide is third-party HPLC and mass-spec tested to ≥99% purity, and that every batch is independently tested before release by accredited third-party laboratories — never self-reported. Each peptide carries a unique identifier tied to its Certificate of Analysis." />
