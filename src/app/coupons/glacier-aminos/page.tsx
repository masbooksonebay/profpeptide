      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="How does Glacier Aminos test its peptides?" a="Glacier Aminos applies a seven-step testing protocol to its compounds. Three categories of results are visible on the public Certificates of Analysis: identity, mass, and endotoxin testing. Testing is performed by independent USA-based laboratories." />
