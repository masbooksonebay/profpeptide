...
export default function GlacierAminosCouponPage() {
  ...
  return (
    <div className="section max-w-3xl">
      ...
      <CouponFacts slug="glacier-aminos" />
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Glacier Aminos publishes a public, batch-searchable Certificate of Analysis library &mdash; enter a batch number at glacieraminos.shop to pull the matching COA. Its certificates are issued by independent US labs: Forever Young Pharmacy (Carlsbad, CA) on 2025 lots and Freedom Diagnostics on 2026 lots. Every report gives purity by HPLC (a ≥98% specification) and net peptide content; the Forever Young reports add pH and single/total impurity limits, while the recent Freedom Diagnostics reports test three vials per batch and add an endotoxin screen (≤0.05 EU/mL) and mass-spectrometry identity confirmation, carrying a per-record search code at FreedomDiagnosticsTesting.com. Glacier describes its process as a seven-step testing protocol, and its batch-level traceability lets researchers match the specific batch received to its report rather than a generic product-page certificate.
          </p>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="Does Glacier Aminos have a discount code?" a={`Yes. Use code PROFPEPTIDE at checkout to save 10% on your entire Glacier Aminos order. This code is verified and maintained by Prof. Peptide and valid as of ${CODES_VERIFIED_DATE}.`} />
            <FAQItem q="How do I use the Glacier Aminos discount code?" a="Add your items to cart at glacieraminos.shop, proceed to checkout, and enter PROFPEPTIDE in the discount code field. The 10% discount will be applied to your order total." />
            <FAQItem q="How does Glacier Aminos test its peptides?" a="Glacier Aminos publishes a public, batch-searchable COA library. Its certificates are issued by independent US labs — Forever Young Pharmacy (Carlsbad, CA) on 2025 lots and Freedom Diagnostics on 2026 lots — reporting purity by HPLC and net peptide content, with the recent Freedom Diagnostics reports adding three-vial testing, an endotoxin screen, and mass-spectrometry identity confirmation. Glacier describes its process as a seven-step testing protocol." />
            <FAQItem q="How do I verify a Glacier Aminos Certificate of Analysis?" a="Every Glacier Aminos batch is traceable. Each Certificate of Analysis is tied to a batch number, and researchers can search that batch number directly on glacieraminos.shop to pull the matching COA. The recent Freedom Diagnostics reports also carry a per-record search code checkable at FreedomDiagnosticsTesting.com, so documentation can be matched to the specific batch received rather than a generic product-page certificate." />
