  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-4">BioCollex catalog &amp; prices</h2>
