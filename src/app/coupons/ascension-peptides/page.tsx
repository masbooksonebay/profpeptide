      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
            ...
            <Link href="/peptides/semaglutide" className="text-[#0891b2] hover:underline">Semaglutide</Link>, recovery peptides including{" "}
            ...
            <Link href="/peptides/cjc-1295" className="text-[#0891b2] hover:underline">CJC-1295</Link> and{" "}
            <Link href="/peptides/ipamorelin" className="text-[#0891b2] hover:underline">Ipamorelin</Link>, skin health compounds including{" "}
            <Link href="/peptides/ghk-cu" className="text-[#0891b2] hover:underline">GHK-Cu</Link> and Melanotan, and longevity compounds including{" "}
            ...
            <Link href="/peptides/mots-c" className="text-[#0891b2] hover:underline">MOTS-c</Link>. Pre-formulated stacks including the{" "}
            <Link href="/peptides/wolverine-stack" className="text-[#0891b2] hover:underline">Wolverine Stack</Link> and{" "}
            <Link href="/peptides/ghk-cu" className="text-[#0891b2] hover:underline">GLOW blend</Link> are also available.
          </p>
        </div>
      </div>
    </div>
