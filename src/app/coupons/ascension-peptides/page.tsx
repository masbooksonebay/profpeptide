...
export default function AscensionPeptidesCouponPage() {
 ...
 <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100">Ascension Peptides Discount Code &mdash; Save 50%</h1>
 </div>
 ...
 <RegionPill slug="ascension-peptides" />
 </div>
 ...
 <div>
 <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-4">Ascension Peptides catalog &amp; prices</h2>
