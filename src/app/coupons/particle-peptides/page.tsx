      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
            ...
            <Link href="/peptides/ghk-cu" className="text-[#0891b2] hover:underline">GHK-Cu</Link>, LL-37, and KPV. Growth hormone secretagogues include{" "}
            <Link href="/peptides/ipamorelin" className="text-[#0891b2] hover:underline">Ipamorelin</Link>,{" "}
            <Link href="/peptides/cjc-1295" className="text-[#0891b2] hover:underline">CJC-1295</Link> with DAC, Mod GRF 1-29 (CJC-1295 no DAC), GHRP-2, GHRP-6, and Hexarelin. Longevity and anti-aging compounds include{" "}
            <Link href="/peptides/epitalon" className="text-[#0891b2] hover:underline">Epithalon</Link>,{" "}
            <Link href="/peptides/mots-c" className="text-[#0891b2] hover:underline">MOTS-c</Link>, Pinealon, Thymalin, and{" "}
            <Link href="/peptides/thymosin-alpha-1" className="text-[#0891b2] hover:underline">Thymosin Alpha-1</Link>. Weight loss compounds include{" "}
            <Link href="/peptides/retatrutide" className="text-[#0891b2] hover:underline">Retatrutide</Link> and{" "}
            <Link href="/peptides/aod-9604" className="text-[#0891b2] hover:underline">AOD-9604</Link>. Cognitive compounds include{" "}
            <Link href="/peptides/semax" className="text-[#0891b2] hover:underline">Semax</Link> and{" "}
            <Link href="/peptides/selank" className="text-[#0891b2] hover:underline">Selank</Link>. Sleep research compounds include DSIP. Reproductive health compounds include{" "}
            <Link href="/peptides/melanotan-ii" className="text-[#0891b2] hover:underline">Melanotan 2</Link>. Their specialty catalog also includes FOXO4-DRI (Proxofim), a rare senolytic compound.
          </p>
        </div>
      </div>
    </div>
