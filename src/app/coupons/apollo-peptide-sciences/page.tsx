  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d] dark:text-slate-100">Apollo Peptide Sciences Discount Code &mdash; Save 10%</h1>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] dark:text-slate-100 mb-2">What Does Apollo Peptide Sciences Carry?</h2>
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
            ...
            <Link href="/peptides/semaglutide" className="text-[#0891b2] hover:underline">Semaglutide</Link>, GLP-2 compounds such as{" "}
            <Link href="/peptides/tirzepatide" className="text-[#0891b2] hover:underline">Tirzepatide</Link>, and GLP-3 compounds such as{" "}
            <Link href="/peptides/retatrutide" className="text-[#0891b2] hover:underline">Retatrutide</Link>, alongside individual peptides spanning repair, cognitive, and cellular health research applications. Bacteriostatic water and research bundles are also available.
          </p>
        </div>
      </div>
    </div>
