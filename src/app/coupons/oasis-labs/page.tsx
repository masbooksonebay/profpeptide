...
export default function OasisLabsCouponPage() {
 ...
 <div>
 <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-4">Oasis Labs catalog &amp; prices</h2>
