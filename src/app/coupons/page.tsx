...
const coupons = [
  { vendor: "Apollo Peptide Sciences", code: "PROFPEPTIDE", discount: "10% off", verified: true, note: "Use code at checkout for 10% off." },
  { vendor: "Ascension Peptides", code: "PROFPEPTIDE", discount: "20% off", verified: true, note: "Use code at checkout for 20% off." },
        ...
        {coupons.map((c) => (
          <div key={c.vendor} className="card">
            ...
            <div className="flex items-center gap-3">
              <code className="bg-gray-100 px-4 py-2 rounded-md text-sm font-mono font-bold text-[#1e2d3d] tracking-widest">
                {c.code}
              </code>
              <span className="tag text-xs">General</span>
            </div>
          </div>
        ))}
      </div>
