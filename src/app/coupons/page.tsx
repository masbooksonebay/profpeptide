...
const coupons = [
  {
    ...
    category: "General",
    verified: true,
    note: "Works sitewide on all research peptides.",
  },
  {
    ...
    category: "Nootropics",
    verified: true,
    note: "Valid on first order. Use at checkout.",
  },
  {
    ...
    category: "General",
    verified: true,
    note: "Applies to all peptide products.",
  },
  {
    ...
    category: "General",
    verified: false,
    note: "May require minimum order. Check site for current terms.",
  },
];
