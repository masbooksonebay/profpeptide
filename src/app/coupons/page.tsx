export const metadata = {
    ...
    description: "Verified peptide coupon codes and discount codes for trusted research suppliers — updated regularly.",
};
...
export default function CouponsPage() {
    return (
          <div className="section max-w-3xl">
                ...
                <h1 className="text-3xl font-bold text-[#1e2d3d] mb-3">Discount Codes</h1>h1>
                                  ...
                                  <div className="flex items-start justify-between gap-4">
                                                <div>
                                                                <div className="flex items-center gap-2 mb-1">
                                                                  ...
                                                                  {c.verified ? (
                                            <span className="text-xs bg-green-50 text-green-700 border border-green-200 px-2 py-0.5 rounded-full">Verified</span>span>
                                          ) : (
                                            <span className="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full">Unverified</span>span>
                                                                                  )}
                                                                </div>div>
