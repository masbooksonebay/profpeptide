...
export const metadata = buildPageMetadata({
  ...
  description:
    "Use Fusion Peptide discount code MARK15 to save 15% on research peptides. Verified promo code updated May 2026. Topical and nasal spray formats available.",
});
