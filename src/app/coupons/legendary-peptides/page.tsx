  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100">Legendary Peptides Discount Code: PROFPEPTIDE &mdash; Save {discountPct}%</h1>
      </div>
      ...
      <div className="space-y-8">
        <div>
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Legendary Peptides (legendarypeptides.com) is a US-based research-peptide supplier whose catalog spans single-compound peptides, multi-peptide blends, and bacteriostatic diluents, with free shipping on orders over $200. Popular compounds by research area:
          </p>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
            Legendary Peptides lists a US phone number and ships domestically. All products are sold for laboratory and research use only.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="Does Legendary Peptides have a coupon code?" a={`Yes. Use code PROFPEPTIDE at checkout to save ${discountPct}% on your entire Legendary Peptides order. This code is verified and maintained by Prof. Peptide.`} />
