    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Legendary Peptides states that every product is third-party tested to ensure the highest purity and quality standards, and describes its mission as delivering lab-tested peptides with purity, consistency, and reliability. Its public site does not name the testing lab, publish a COA library, or state a single headline purity percentage &mdash; so researchers who need batch documentation should request it directly before purchase.
          </p>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="How does Legendary Peptides test its peptides?" a="Legendary states that every product is third-party tested to ensure the highest purity and quality standards, and describes its peptides as lab-tested for purity, consistency, and reliability. The public site does not name the testing lab, publish a COA library, or state a single purity percentage; researchers who need a batch Certificate of Analysis should request it before purchase." />
