    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Legendary Peptides states that every product is third-party tested to ensure the highest purity and quality standards, and describes its mission as delivering lab-tested peptides with purity, consistency, and reliability. Legendary publishes a batch-specific Certificate of Analysis on each product page, with a verification link to the issuing third-party lab, Freedom Diagnostics &mdash; covering identity (LC-MS), purity (HPLC-UV), net content, and endotoxin. Legendary also states that it screens Asia-sourced material for fentanyl.
          </p>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="How does Legendary Peptides test its peptides?" a="Legendary states that every product is third-party tested to ensure the highest purity and quality standards, and describes its peptides as lab-tested for purity, consistency, and reliability. Legendary publishes a batch-specific Certificate of Analysis on each product page, verifiable through the issuing third-party lab, Freedom Diagnostics, covering identity (LC-MS), purity (HPLC-UV), net content, and endotoxin. Legendary also states that it screens Asia-sourced material for fentanyl." />
