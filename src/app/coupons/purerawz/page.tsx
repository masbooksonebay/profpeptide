  ...
  return (
      ...
      <CouponBreadcrumb slug="purerawz" />
        ...
        <div className="flex flex-wrap items-center gap-3 mb-1">
          <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100">PureRawz Discount Code: {v.code} &mdash; Save {discountPct}%</h1>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <FAQItem q="Does PureRawz have a coupon code?" a={`Yes. Use code PROF10 at checkout for ${discountPct}% off your entire order at PureRawz. This code is verified by Prof. Peptide and updated regularly.`} />
              <FAQItem q="How do I use the PureRawz coupon code?" a={`Add compounds to your cart at purerawz.co, proceed to checkout, and enter PROF10 in the discount code field. The ${discountPct}% discount applies to your order total before payment.`} />
