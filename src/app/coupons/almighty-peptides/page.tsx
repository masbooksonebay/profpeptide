...
export default function AlmightyPeptidesCouponPage() {
  const v = vendors["almighty-peptides"];
  const rows = vendorProductRows("almighty-peptides");
  const discountPct = vendorDiscountPct("almighty-peptides");
  const autoApply = codeAutoApplies("almighty-peptides");
  const shopUrl = makeShopUrlFor("almighty-peptides");
 return (
 ...
 <div>
   <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-4">Almighty Peptides catalog &amp; prices</h2>
   ...
   <div className="border border-gray-100 dark:border-slate-700 rounded-xl p-6 bg-gray-50 dark:bg-[#1e293b] mb-6">
     ...
     <VerifiedBadge slug="almighty-peptides" />
   ...
   <p className="text-xs text-gray-400 dark:text-slate-500 mt-3">
     Struck-through prices are Almighty Peptides&apos; list price; the bold figure is{" "}
     {autoApply ? (
