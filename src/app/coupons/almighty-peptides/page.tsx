      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
            ...
            <Link href="/peptides/retatrutide" className="text-[#0891b2] hover:underline">Retatrutide</Link>, recovery peptides including{" "}
            ...
            <Link href="/peptides/sermorelin" className="text-[#0891b2] hover:underline">Sermorelin</Link>, and{" "}
            <Link href="/peptides/tesamorelin" className="text-[#0891b2] hover:underline">Tesamorelin</Link>, longevity compounds including{" "}
            <Link href="/supplements/nad-plus" className="text-[#0891b2] hover:underline">NAD+</Link>,{" "}
            <Link href="/peptides/epitalon" className="text-[#0891b2] hover:underline">Epitalon</Link>, and{" "}
            <Link href="/peptides/mots-c" className="text-[#0891b2] hover:underline">MOTS-c</Link>, skin health compounds including{" "}
            <Link href="/peptides/ghk-cu" className="text-[#0891b2] hover:underline">GHK-Cu</Link>, and sexual health compounds including{" "}
            <Link href="/peptides/pt-141" className="text-[#0891b2] hover:underline">PT-141</Link> and{" "}
            <Link href="/peptides/melanotan-ii" className="text-[#0891b2] hover:underline">Melanotan II</Link>. Their capsule catalog includes BPC-157, GHK-Cu, Methylene Blue, MK-677, LGD-4033, and SLU-PP-332. Their liquids catalog covers SARMs, aromatase inhibitors, and other research chemicals.
          </p>
        </div>
      </div>
    </div>
