      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="Is LA Peptides third-party tested?" a="LA Peptides states that every batch undergoes third-party testing to a minimum purity of ≥99%. Confirm the current Certificate of Analysis for any specific compound on the vendor's site before purchase." />
