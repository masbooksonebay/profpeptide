      ...
      <div className="space-y-8">
        <div>
          ...
          <dl className="space-y-2 mb-4">
            <Cat label="Metabolic Authority"><P slug="cagrilintide">Cagrilintide</P>, a coded GLP-class line listed as GLP-RT and GLP-TZ, and HCG</Cat>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Forge labels its GLP-class metabolic compounds with coded names &mdash; GLP-RT and GLP-TZ. We do not decode them here: the naming follows the GLP-tier convention other vendors use, but Forge does not disclose the underlying compound on the catalog page, and we have no first-hand confirmation of the mapping, so we leave those two listed under their codes rather than assert a compound identity we cannot verify.
          </p>
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
