      ...
      <div className="space-y-8">
        <div>
          ...
          <dl className="space-y-2 mb-4">
            <Cat label="Metabolic &amp; Weight Loss"><P slug="semaglutide">Semaglutide</P> (listed as GLP-1S), <P slug="tirzepatide">Tirzepatide</P> (listed as GLP-2T), <P slug="retatrutide">Retatrutide</P> (listed as GLP-3R), <P slug="cagrilintide">Cagrilintide</P> (in the C-Amylin / GLP-1S blend), <P slug="mots-c">MOTS-C</P></Cat>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Capstone labels its GLP-class metabolic compounds with coded names that follow the GLP-1/2/3 tier convention: GLP-1S is Semaglutide, GLP-2T is Tirzepatide, and GLP-3R is Retatrutide; the C-Amylin / GLP-1S blend is Cagrilintide + Semaglutide. We list each under both its compound name and its code &mdash; &ldquo;Semaglutide (listed as GLP-1S)&rdquo; &mdash; so a reader searching Capstone&rsquo;s store for the coded name still lands on the right compound.
          </p>
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
