  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100">Modern Aminos Discount Code &mdash; Save {discountPct}%</h1>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="Does Modern Aminos have a discount code?" a={`Yes. Use code PROFPEPTIDE at checkout to save ${discountPct}% on your entire Modern Aminos order. This code is verified and maintained by Prof. Peptide and valid as of ${CODES_VERIFIED_DATE}.`} />
            <FAQItem q="How do I use the Modern Aminos discount code?" a={`Log in to your Modern Aminos account at modernaminos.com, add your items to cart, proceed to checkout, and enter PROFPEPTIDE in the discount code field. The ${discountPct}% discount will be applied to your order total.`} />
