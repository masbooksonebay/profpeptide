      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="Does Modern Aminos have a coupon code?" a={`Yes. Use code PROFPEPTIDE at checkout to save ${discountPct}% on your entire Modern Aminos order. This code is maintained by Prof. Peptide${isCodeVerified("modern-aminos") ? ` and verified as of ${CODES_VERIFIED_DATE}` : ""}.`} />
