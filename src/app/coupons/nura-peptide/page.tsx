        ...
        <div>
          ...
          <dl className="space-y-2 mb-4">
            <div className="flex flex-col sm:flex-row sm:gap-3 text-sm">
              ...
              <dd className="text-gray-600 dark:text-slate-300">
                <Link href="/peptides/retatrutide" className="text-[#3A759F] hover:underline">Retatrutide</Link> (GLP-3R), <Link href="/peptides/tirzepatide" className="text-[#3A759F] hover:underline">Tirzepatide</Link> (GLP-2T), <Link href="/peptides/semaglutide" className="text-[#3A759F] hover:underline">Semaglutide</Link> (GLP-1SG), <Link href="/peptides/cagrilintide" className="text-[#3A759F] hover:underline">Cagrilintide</Link> (in the GLP-3R/CAG blend), <Link href="/peptides/mots-c" className="text-[#3A759F] hover:underline">MOTS-C</Link>, <Link href="/peptides/aod-9604" className="text-[#3A759F] hover:underline">AOD-9604</Link>, <Link href="/peptides/5-amino-1mq" className="text-[#3A759F] hover:underline">5-Amino-1MQ</Link>
              </dd>
            </div>
            <div className="flex flex-col sm:flex-row sm:gap-3 text-sm">
          ...
          <div className="border border-gray-100 dark:border-slate-700 rounded-xl p-4 bg-gray-50 dark:bg-[#1e293b] mb-4">
            <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
              <span className="font-semibold text-[#16181B] dark:text-slate-100">Finding the GLP compounds on Nura&apos;s site:</span> Nura lists its metabolic/GLP peptides under proprietary code names. Retatrutide (GLP-3R), Tirzepatide (GLP-2T), and Semaglutide (GLP-1SG); the GLP-3R/CAG blend is Retatrutide + Cagrilintide &mdash; search those codes in the Nura catalog to reach the corresponding product page.
            </p>
          </div>
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
