    ...
    <div className="section max-w-3xl">
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            PureRx runs a multi-step quality-control process: samples are sent to an ISO-certified laboratory and analyzed by HPLC, mass spectrometry, and other methods, and every batch is independently tested for identity and purity before it is approved for release. Each approved batch is issued a Certificate of Analysis documenting its results. COAs are available for applicable products and include third-party testing information to help researchers verify product identity.
          </p>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="How does PureRx Peptides test its peptides?" a="PureRx runs a multi-step process: samples are sent to an ISO-certified lab and analyzed by HPLC, mass spectrometry, and other methods, and every batch is independently tested for identity and purity before release. Each approved batch is then issued a Certificate of Analysis documenting its results." />
