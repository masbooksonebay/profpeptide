...
export default function IgnitePeptidesLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"Offer\",\"name\":\"Ignite Peptides Discount Code - Save 10%\",\"description\":\"Use code PROF10 for 10% off at Ignite Peptides\",\"url\":\"https://profpeptide.com/coupons/ignite-peptides\",\"validFrom\":\"2026-05-01\",\"priceValidUntil\":\"2026-05-31\",\"seller\":{\"@type\":\"Organization\",\"name\":\"Ignite Peptides\"}}" }} />
      {children}
    </>
  );
}
