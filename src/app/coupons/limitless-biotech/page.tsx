  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d]">Limitless Biotech Discount Code &mdash; Save 10%</h1>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#1e2d3d] mb-2">What Does Limitless Biotech Carry?</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <Link href="/peptides/ipamorelin" className="text-[#0D7377] hover:underline">Ipamorelin</Link>, and{" "}
            <Link href="/peptides/cjc-1295" className="text-[#0D7377] hover:underline">CJC-1295</Link>, metabolic compounds including{" "}
            <Link href="/peptides/aod-9604" className="text-[#0D7377] hover:underline">AOD-9604</Link> and{" "}
            <Link href="/peptides/semaglutide" className="text-[#0D7377] hover:underline">Semaglutide</Link>, cognitive and nootropic compounds including{" "}
            <Link href="/peptides/selank" className="text-[#0D7377] hover:underline">Selank</Link> and{" "}
            <Link href="/peptides/semax" className="text-[#0D7377] hover:underline">Semax</Link>, longevity compounds including{" "}
            <Link href="/peptides/epitalon" className="text-[#0D7377] hover:underline">Epitalon</Link>,{" "}
            <Link href="/peptides/mots-c" className="text-[#0D7377] hover:underline">MOTS-c</Link>, and{" "}
            <Link href="/supplements/nad-plus" className="text-[#0D7377] hover:underline">NAD+</Link>, and sexual health compounds including{" "}
