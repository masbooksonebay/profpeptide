...
export default function PeptidesGgCouponPage() {
 ...
 <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100">Peptides.gg Discount Code &mdash; Save 15%</h1>
 </div>
 <div className="flex flex-wrap items-center gap-2 mb-8">
 <span className="text-xs bg-green-50 text-green-700 border border-green-200 px-2 py-0.5 rounded-full font-medium">Verified</span>
 <RegionPill slug="peptides-gg" />
 </div>
 ...
 <div>
 <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-4">Peptides.gg catalog &amp; prices</h2>
 ...
 <VerifiedBadge slug="peptides-gg" />
