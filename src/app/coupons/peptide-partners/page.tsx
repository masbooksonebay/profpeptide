...
export default function PeptidePartnersCouponPage() {
  ...
  const rows = vendorProductRows("peptide-partners");
  const discountPct = vendorDiscountPct("peptide-partners");
  const autoApply = codeAutoApplies("peptide-partners");
  const shopUrl = makeShopUrlFor("peptide-partners");
  return (
 ...
 <RegionPill slug="peptide-partners" />
 </div>
 ...
 <Link href="/peptides/retatrutide" className="text-[#3A759F] hover:underline">Retatrutide</Link>, <Link href="/peptides/tirzepatide" className="text-[#3A759F] hover:underline">Tirzepatide</Link>, <Link href="/peptides/semaglutide" className="text-[#3A759F] hover:underline">Semaglutide</Link>, <Link href="/peptides/cagrilintide" className="text-[#3A759F] hover:underline">Cagrilintide</Link>, <Link href="/peptides/mots-c" className="text-[#3A759F] hover:underline">MOTS-c</Link>
 </dd>
 </div>
 <div className="flex flex-col sm:flex-row sm:gap-3 text-sm">
 ...
 <div>
 <h2 className="text-lg font-semibold text-[#16181B] dark:text-slate-100 mb-4">Peptide Partners catalog &amp; prices</h2>
 ...
 <VerifiedBadge slug="peptide-partners" />
 ...
 Struck-through prices are Peptide Partners&apos; list price; the bold figure is{" "}
 {autoApply ? (
