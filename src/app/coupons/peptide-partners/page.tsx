  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-2 mb-8">
        ...
        <span className="text-xs bg-amber-100 text-amber-800 dark:text-amber-300 border border-amber-300 px-2 py-0.5 rounded-full font-medium">Editor&apos;s Pick</span>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">
            ...
            <Link href="/peptides/tb-500" className="text-[#0891b2] hover:underline">TB-500</Link>, and combination blends.
            ...
            <Link href="/supplements/nad-plus" className="text-[#0891b2] hover:underline">NAD+</Link>, SS-31, and Humanin,
            and immune peptides including{" "}
            <Link href="/peptides/thymosin-alpha-1" className="text-[#0891b2] hover:underline">Thymosin Alpha-1</Link> and{" "}
