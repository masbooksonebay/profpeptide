...
export default function TreasureCoastPeptidesCouponPage() {
  ...
  return (
    <div className="section max-w-3xl">
      ...
      <CouponFacts slug="treasure-coast-peptides" />
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="How does Treasure Coast Peptides test its peptides?" a="Treasure Coast's research peptides are third-party tested for identity, purity, and concentration. The concentration testing verifies the labeled potency of the material. Each product page publishes a batch-specific Certificate of Analysis, issued by Janoshik Analytical or Freedom Diagnostics." />
