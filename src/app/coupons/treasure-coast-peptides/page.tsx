      ...
      <div className="space-y-8">
        <div>
          ...
          <dl className="space-y-2 mb-4">
            ...
            <div className="flex flex-col sm:flex-row sm:gap-3 text-sm">
              ...
              <dd className="text-gray-600 dark:text-slate-300">
                <Link href="/peptides/bpc-157" className="text-[#3A759F] hover:underline">BPC-157</Link>, <Link href="/peptides/tb-500" className="text-[#3A759F] hover:underline">TB-500</Link>, <Link href="/peptides/wolverine-stack" className="text-[#3A759F] hover:underline">BPC-157 + TB-500</Link>, <Link href="/peptides/cibinetide" className="text-[#3A759F] hover:underline">Cibinetide (ARA-290)</Link>
              </dd>
            </div>
            <div className="flex flex-col sm:flex-row sm:gap-3 text-sm">
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Treasure Coast&apos;s research peptides are third-party tested for identity, purity, and concentration &mdash; the concentration check verifies the labeled potency of the material, not just its identity. Certificates exist but aren&apos;t linked from the rendered product pages; they&apos;re reachable only through the WordPress media API, embedded in product photo galleries. Of 25 products we sampled, 6 had a discoverable certificate. Freedom Diagnostics is the current, primary lab &mdash; one certificate we checked came back byte-identical (MD5) to that laboratory&apos;s own copy, with the accession prefix checked against collision. Janoshik appears on one older certificate, a GLOW report dated April 2025. That&apos;s a partial picture, not a full published library: most of the catalog has no discoverable certificate. Product listings carry a &ldquo;Third Party Tested&rdquo; assurance, and orders are covered by a satisfaction / money-back guarantee, easy returns, and secure ordering.
          </p>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="Does Treasure Coast Peptides have a coupon code?" a={`Yes. Use code PROFPEPTIDE at checkout to save ${discountPct}% on your entire Treasure Coast Peptides order. This code is maintained by Prof. Peptide${isCodeVerified("treasure-coast-peptides") ? ` and verified as of ${CODES_VERIFIED_DATE}` : ""}.`} />
            ...
            <FAQItem q="How does Treasure Coast Peptides test its peptides?" a="Treasure Coast states its research peptides are third-party tested for identity, purity, and concentration (the concentration check verifies labeled potency). Certificates exist but aren't linked from product pages — they're reachable only through the WordPress media API. Of 25 products we sampled, 6 had a discoverable certificate: Freedom Diagnostics is the current, primary lab (one certificate byte-matched the lab's own copy), and Janoshik appears on one older, April 2025 GLOW report. Coverage is partial, not a full published library." />
