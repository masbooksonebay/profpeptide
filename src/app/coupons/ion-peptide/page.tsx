      ...
      <div className="space-y-8">
        <div>
          ...
          <dl className="space-y-2 mb-4">
            <Cat label="Metabolic &amp; Weight Loss"><P slug="semaglutide">Semaglutide</P> (listed as ION-1S), <P slug="tirzepatide">Tirzepatide</P> (listed as ION-2T), <P slug="retatrutide">Retatrutide</P> (listed as ION-3R), <P slug="cagrilintide">Cagrilintide</P>, <P slug="aod-9604">AOD-9604</P>, <P slug="5-amino-1mq">5-Amino-1MQ</P></Cat>
