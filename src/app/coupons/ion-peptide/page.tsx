  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#16181B] dark:text-slate-100">Ion Peptide Discount Code &mdash; Save 15%</h1>
      </div>
      ...
      <div className="space-y-8">
        <div>
          ...
          <dl className="space-y-2 mb-4">
            <Cat label="Metabolic &amp; Weight Loss"><P slug="cagrilintide">Cagrilintide</P>, <P slug="aod-9604">AOD-9604</P>, <P slug="5-amino-1mq">5-Amino-1MQ</P>, plus coded GLP compounds ION-1S / ION-2T / ION-3R</Cat>
          ...
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
            Ion labels its GLP-class metabolic compounds with coded names &mdash; ION-1S, ION-2T, and ION-3R &mdash; that follow the GLP-1/2/3 tier convention (which typically maps to Semaglutide, Tirzepatide, and Retatrutide respectively). Because we have not yet matched those codes to a specific compound on a certificate, we list them under their coded names rather than asserting an identity.
          </p>
          <p className="text-sm text-gray-600 dark:text-slate-300 leading-relaxed mb-4">
        ...
        <div>
          ...
          <div className="space-y-2">
            <FAQItem
              ...
              a="Ion Peptide carries a broad research catalog spanning metabolic and GLP-class compounds (Cagrilintide, AOD-9604, 5-Amino-1MQ, and the coded ION-1S/2T/3R line), recovery peptides (BPC-157, TB-500, KPV, the Wolverine blend), growth-hormone secretagogues (CJC-1295, Ipamorelin, GHRP-2, GHRP-6, Fragment 176-191), skin and anti-aging compounds (GHK-Cu, GLOW, KLOW, Melanotan I and II), longevity and cognitive compounds (Epitalon, Glutathione, FOXO4-DRI, DSIP), PT-141, and a separate line of cosmetic formulations. Its catalog and per-vial prices are openly browsable."
            />
            <FAQItem
              q="Does Ion Peptide have a discount code?"
              a="Yes. Use code PROFPEPTIDE at checkout to save 15% on any Ion Peptide order. This code is verified and maintained by Prof. Peptide."
            />
            <FAQItem
              q="How do I use the Ion Peptide discount code?"
              a="Add your items to cart at ionpeptide.com, proceed to checkout, and enter PROFPEPTIDE in the discount code field. The 15% discount will be applied to your order total. Checkout runs through Ion's Wholesale Research Supply Portal, which requires a customer account."
            />
            <FAQItem
