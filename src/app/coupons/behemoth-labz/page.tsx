  ...
  return (
    <div className="section max-w-3xl">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-1">
        <h1 className="text-3xl font-bold text-[#1e2d3d] dark:text-slate-100">Behemoth Labz Discount Code</h1>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <FAQItem q="Does Behemoth Labz have a discount code?" a="A Behemoth Labz discount code is coming soon. Check back on this page for an exclusive Prof. Peptide code once available." />
